...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header" style="width: 100%; display: flex; justify-content: center; font-weight: bold; font-size: 15pt">{{ __('REGISTER') }}</div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="roles_id" class="form-control" name="roles_id" required>
                                    ...
                                    <option value="5">Production - Batching 2</option>
                                    <option value="6">Filling</option>
                                </select>
                            </div>
                        </div>
