                                        ...
                                        <!--begin: Wizard Form-->
                                            ...
                                            <div class="pb-6" style="margin-left: 50px; margin-right: 50px;">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-5 col-md-9 col-sm-12">
                                                        <div class="input-group date">
                                                            <input type="text" class="form-control" value="{{$verifikasi->masa_kerja_gol_tahun}}" autocomplete="off" disabled require />
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-5 col-md-9 col-sm-12">
                                                        <div class="input-group date">
                                                            <input type="text" class="form-control" value="{{$verifikasi->masa_kerja_gol_bulan}}" autocomplete="off" disabled require />
                                            ...
                                            <div class="pb-6" style="margin-left: 50px; margin-right: 50px;">
                                                ...
                                                <div class="d-flex justify-content-between mt-5 pt-10" style="margin-left: 50px; margin-right: 50px;">
                                                    ...
                                                    <div>
                                                        ...
                                                        <th style="margin-right: 10px;">
                                                            <form method="POST" action="{{ route('koor-pokja-kp.pertek.kenaikan_pangkat.store_tolak') }}">
                                                                @csrf 
                                                                <input type="hidden" class="btn btn-warning font-weight-bolder text-uppercase px-9 py-4" name="v_id" value="{{ $verifikasi->id }}">
                                                                <input type="hidden" class="btn btn-warning font-weight-bolder text-uppercase px-9 py-4" name="v_jenis" value="{{ $verifikasi->jenis_layanan }}">
                                                        ...
                                                        <th style="margin-right: 10px;">
                                                            <form method="POST" action="{{ route('koor-pokja-kp.pertek.kenaikan_pangkat.store_proses') }}">
                                                                @csrf 
                                                                <input type="hidden" class="btn btn-warning font-weight-bolder text-uppercase px-9 py-4" name="v_id" value="{{ $verifikasi->id }}">
                                                                <input type="hidden" class="btn btn-warning font-weight-bolder text-uppercase px-9 py-4" name="v_jenis" value="{{ $verifikasi->jenis_layanan }}">
