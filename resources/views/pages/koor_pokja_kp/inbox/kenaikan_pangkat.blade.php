                                                ...
                                                <tbody>
                                                    @foreach($pengangkatans as $pengangkatan)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="{{route('koor-pokja-kp.inbox.kenaikan_pangkat.verif', ['id' => $pengangkatan->id])}}"><i class="fa fa-pencil-alt text-success mr-2"></i></a>
                                                                <a href="{{route('koor-pokja-kp.inbox.distributor.index', ['id' => $pengangkatan->id, 'jenis_layanan' => $pengangkatan->jenis_layanan])}}"><i class="fa fa-share text-info mr-1"></i></a>
                                                            </td>
                                                        </tr>
                                                    @endforeach
                                                </tbody>
                                            ...
                                            <tbody>
                                                @foreach($kenaikan_pendings as $kenaikan_pending)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{route('koor-pokja-kp.inbox.detail-surat-pengembalian.index', ['id' => $kenaikan_pending->id])}}" type="button" class="btn btn-warning btn-sm">
                                                                Lihat
                                                            </a>
                                                        </td>
                                                    </tr>
