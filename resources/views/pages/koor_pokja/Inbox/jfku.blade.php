                                            ...
                                            <table class="datatable datatable-bordered datatable-head-custom" id="kt_datatable">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>Kemen PUPERA</td>
                                                        <td>
                                                            <div style="color: #FFA800;">Kenaikan Jenjang JFKU</div>
                                                        </td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a data-toggle="modal" data-target="#exampleModalSizeXl" href=""><i class="fa fa-share text-info mr-1"></i></a>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>BKN</td>
                                                        <td>
                                                            <div style="color: #FFA800;">Perpindahan dari JPT Pratama ke dalam JFKU</div>
                                                        </td>
                                                        <td><div style="color: #3699FF;">19187678956987</div></td>
                                                        <td>Painem</td>
                                                        <td>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="mb-7">
                                            <div class="row align-items-center">
                                                <div class="col-lg-9 col-xl-8">
                                                    <div class="row align-items-center">
                                                        <div class="col-md-4 my-2 my-md-0 col-lg-8">
                                        ...
                                        <div class="d-flex justify-content-between mt-5 pt-10">
                                            ...
                                            <div>
                                                <a type="button" class="btn btn-primary font-weight-bolder text-uppercase px-9 py-4" href="custom/pages/form/rkp/text_editor.html">Memo RKP</a>
                                            </div>
                                        </div>																	
                                    </div>								
                                </div>
