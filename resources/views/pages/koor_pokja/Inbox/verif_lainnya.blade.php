                                    ...
                                    <div class="col-xl-20 col-xxl-12">
                                        <!--begin: Wizard Form-->
                                            ...
                                            <div class="pb-6" style="margin-left: 50px; margin-right: 50px;" data-wizard-type="step-content">
                                                ...
                                                @if($verifikasi_lainnya->jenis_layanan == '12' || $verifikasi_lainnya->jenis_layanan == '13')
                                                ...
                                                <div>
                                                    <table>
                                                        <th style="margin-right: 10px;">
                                                            <form method="POST" action="{{ route('koor-pokja.inbox.lainnya.store_tolak') }}">
                                                                @csrf 
                                                        ...
                                                        <th style="margin-right: 10px;">
                                                            <form method="POST" action="{{ route('koor-pokja.inbox.lainnya.store_proses') }}">
                                                                @csrf 
                                                        ...
                                                        <th style="margin-right: 10px;">
                                                            <form method="POST" action="{{ route('koor-pokja.inbox.lainnya.store_pending') }}">
                                                                @csrf 
