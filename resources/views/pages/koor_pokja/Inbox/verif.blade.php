                                                                    ...
                                                                    <form class="form" id="kt_form">
                                                                        ...
                                                                        <div class="pb-6" data-wizard-type="step-content">
                                                                            ...
                                                                            <div class="form-group row">
                                                                                ...
                                                                                <div class="col-lg-9 col-md-9 col-sm-12">
                                                                                    <div class="input-group date">
                                                                                        <a style="color: blue;" href="{{ Storage::disk('local')->get('pengangkatan_pejabat_fungsional_keahlian_utama_attachments/skp_2/'. $verifikasi->file_skp_2) }}">file.pdf</a>
                                                                                    </div>
                                                                                   </div>
                                                                            </div> 
                                                                        ...
                                                                        <div class="d-flex justify-content-between mt-5 pt-10">
                                                                            ...
                                                                            <div>
                                                                                ...
                                                                                <a href="custom/pages/pengusulan_int.html" type="button" class="btn btn-danger font-weight-bolder text-uppercase px-9 py-4" style="margin-right: 10px;">Tolak</a>
                                                                                <a href="custom/pages/persetujuan.html" type="button" class="btn btn-primary font-weight-bolder text-uppercase px-9 py-4" style="margin-right: 10px;">Proses</a>
                                                                                <a href="custom/pages/pending.html" type="button" class="btn btn-warning font-weight-bolder text-uppercase px-9 py-4" style="margin-right: 10px;">Pending</a>
