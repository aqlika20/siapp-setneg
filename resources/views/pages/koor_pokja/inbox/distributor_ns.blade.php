                                                    ...
                                                    <div class="card-body pl-12">
                                                        <div class="table-responsive">
                                                            <th style="width: 200px;">
                                                                <form method="POST" action="{{ route('koor-pokja.inbox.distributor.store_group', ['id' => $ns->id, 'jenis_layanan' => $ns->jenis_layanan]) }}">
                                                                    @csrf 
                                                                        ...
                                                                        @foreach($group_users as $user)
                                                                            @if($list->name == $user->group && $role == $user->role)
                                                                                <tr>
                                                                                    ...
                                                                                    <td>{{$user->nip}}</td>
                                                                                    <td> 
                                                                                        <form method="POST" action="{{ route('koor-pokja.inbox.distributor.store_distributor', ['id' => $ns->id,  'jenis_layanan' => $ns->jenis_layanan]) }}">
                                                                                            @csrf 
