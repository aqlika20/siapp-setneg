                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach($kenaikans as $kenaikan)
                                                        <tr>
                                                            ...
                                                            <td>{{ $kenaikan->nama }}</td>
                                                            <td>
                                                                <a href="{{route('jf-ahli-pertama-kp.inbox.kenaikan_pangkat.verif', ['id' => $kenaikan->id])}}" type="button" class="btn btn-success font-weight-bold align-items-md-end">Verifikasi</a>
                                                            </td>
                                                        </tr>
                                                    @endforeach
                                            ...
                                            <tbody>
                                                @foreach($kenaikan_pendings as $kenaikan_pending)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="{{route('jf-ahli-pertama-kp.inbox.kenaikan_pangkat.verif', ['id' => $kenaikan_pending->id])}}" type="button" class="btn btn-success font-weight-bold align-items-md-end">Verifikasi</a>
                                                            </td>
                                                        </tr>
                                                    @endforeach
                                            </tbody>
                                            ...
                                            <tbody>
                                                ...
                                                @foreach($kenaikan_tolaks as $kenaikan_tolak)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="{{route('jf-ahli-pertama-kp.inbox.kenaikan_pangkat.verif', ['id' => $kenaikan_tolak->id])}}" type="button" class="btn btn-success font-weight-bold align-items-md-end">Verifikasi</a>
                                                            </td>
                                                        </tr>
                                                    @endforeach
