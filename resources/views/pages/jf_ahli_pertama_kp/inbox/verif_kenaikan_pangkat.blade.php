                                        ...
                                        <!--begin: Wizard Form-->
                                            ...
                                            <div class="pb-6" style="margin-left: 50px; margin-right: 50px;">
                                                ...
                                                <div class="d-flex justify-content-between mt-5 pt-10" style="margin-left: 50px; margin-right: 50px;">
                                                    <div class="mr-2">
                                                        <a href="{{ route('jf-ahli-pertama-kp.inbox.kenaikan_pangkat.store_tolak')}}" type="button" class="btn btn-light-primary font-weight-bolder text-uppercase px-9 py-4">Kembali</a>
                                                    </div>
                                                    <div>
                                                        <table>
                                                            <th style="margin-right: 10px;">
                                                            <form method="POST" action="{{ route('jf-ahli-pertama-kp.inbox.kenaikan_pangkat.store_tolak') }}">
                                                                @csrf 
                                                        ...
                                                        <th style="margin-right: 10px;">
                                                            <form method="POST" action="{{ route('jf-ahli-pertama-kp.inbox.kenaikan_pangkat.store_proses') }}">
                                                                @csrf 
                                                                <input type="hidden" class="btn btn-warning font-weight-bolder text-uppercase px-9 py-4" name="v_id" value="{{ $verifikasi->id }}">
                                                                <input type="hidden" class="btn btn-warning font-weight-bolder text-uppercase px-9 py-4" name="v_jenis" value="{{ $verifikasi->jenis_layanan }}">
                                                        ...
                                                        <th style="margin-right: 10px;">
                                                            <form method="POST" action="{{ route('jf-ahli-pertama-kp.inbox.kenaikan_pangkat.store_pending') }}">
                                                                @csrf 
                                                                <input type="hidden" class="btn btn-warning font-weight-bolder text-uppercase px-9 py-4" name="v_id" value="{{ $verifikasi->id }}">
                                                                <input type="hidden" class="btn btn-warning font-weight-bolder text-uppercase px-9 py-4" name="v_jenis" value="{{ $verifikasi->jenis_layanan }}">
