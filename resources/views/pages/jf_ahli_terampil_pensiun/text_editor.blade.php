                                                ...
                                                <div>
                                                    <table>
                                                        <th style="margin-right: 10px;">
                                                            <form method="POST" action="{{ route('jf-ahli-terampil-pensiun.jfku.store_tolak', ['id' => $verifikasi->id]) }}">
                                                                @csrf 
                                                        ...
                                                        <th style="margin-right: 10px;">
                                                            <form method="POST" action="{{ route('jf-ahli-terampil-pensiun.jfku.store_proses', ['id' => $verifikasi->id]) }}">
                                                                @csrf 
                                                        ...
                                                        <th style="margin-right: 10px;">
                                                            <form method="POST" action="{{ route('jf-ahli-terampil-pensiun.jfku.store_pending', ['id' => $verifikasi->id]) }}">
                                                                @csrf 
