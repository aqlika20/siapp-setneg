                                ...
                                @foreach($rkps as $rkp)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route('tu-menteri.inbox.detail.pertek', ['id' => $rkp->id])}}" type="button" class="btn btn-success btn-xs">
												Detail
											</a>
                                            @elseif($rkp->status == Helper::$verifikasi_rkp_tu_kementerian)
                                            <a href="{{route('tu-menteri.inbox.keppres-maju', ['id' => $rkp->id])}}" type="button" class="btn btn-success btn-xs">
											    Keppres Maju
											</a>
                                            @endif
                                        </td>
