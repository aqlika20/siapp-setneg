                                                ...
                                                <tbody>
                                                    @foreach($pengangkatans as $pengangkatan)
                                                        <tr>
                                                            ...
                                                            <td>{{ $pengangkatan->instansi_induk }}</td>
                                                            ...
                                                            <td>
                                                                <a href="{{route('koor-pokja-pensiun.inbox.pemberhentian.verif', ['id' => $pengangkatan->id])}}"><i class="fa fa-pencil-alt text-success mr-2"></i></a>
                                                                <a href="{{route('koor-pokja-pensiun.inbox.distributor.index', ['id' => $pengangkatan->id, 'jenis_layanan' => $pengangkatan->jenis_layanan])}}"><i class="fa fa-share text-info mr-1"></i></a>
                                                            </td>
                                                        </tr>
                                                    @endforeach
                                                </tbody>
                                                ...
                                                <tbody>
                                                    @foreach($pemberhentian_pendings as $pemberhentian_pending)
                                                        <tr>
                                                            ...
                                                            <td>{{ $pemberhentian_pending->instansi_induk }}</td>
                                                            ...
                                                            <td>
                                                                <a href="{{route('koor-pokja-pensiun.inbox.detail-surat-pengembalian.index', ['id' => $pemberhentian_pending->id])}}" type="button" class="btn btn-warning btn-sm">
                                                                    Lihat
                                                                </a>
                                                            </td>
                                                        </tr>
                                                ...
                                                <tbody>
                                                    @foreach($jfku_tolaks as $jfku_tolak)
                                                        <tr>
                                                            ...
                                                            <td>{{ $jfku_tolak->instansi_induk }}</td>
