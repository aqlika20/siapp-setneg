                                                ...
                                                <div>
                                                    <table>
                                                        <th style="margin-right: 10px;">
                                                            <form method="POST" action="{{ route('jf-ahli-terampil-p4.jfku.store_tolak', ['id' => $verifikasi->id]) }}">
                                                                @csrf 
                                                        ...
                                                        <th style="margin-right: 10px;">
                                                            <form method="POST" action="{{ route('jf-ahli-terampil-p4.jfku.store_proses', ['id' => $verifikasi->id]) }}">
                                                                @csrf 
                                                        ...
                                                        <th style="margin-right: 10px;">
                                                            <form method="POST" action="{{ route('jf-ahli-terampil-p4.jfku.store_pending', ['id' => $verifikasi->id]) }}">
                                                                @csrf 
