                                    ...
                                    <form class="form" id="kt_form" action="{{ route('pic.administrasi.surat-usulan.persetujuan-pengangkatan-staf-khusus.store') }}" enctype="multipart/form-data" method="POST">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-5 col-md-9 col-sm-12">
                                                    <div class="input-group date">
                                                        <input type="text" class="form-control datetimepicker-input my-datepicker" id="tanggal_surat_pengantar" name="tanggal_surat_pengantar" data-toggle="datetimepicker" data-target="#tanggal_surat_pengantar" placeholder="Pilih Tanggal" value="{{old('tanggal_surat_pengantar')}}" />
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-md-9 col-sm-12">
                                                    <div class="input-group">
                                                        <input type="text" class="form-control" id="no_surat_pengantar" name="no_surat_pengantar" value="{{old('no_surat_pengantar')}}" autocomplete="off" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                        ...
                                        <div class="pb-6" style="margin-left: 50px; margin-right: 50px;" data-wizard-type="step-content">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-md-9 col-sm-12">
                                                    <div class="input-group date">
                                                        <input type="text" class="form-control" id="jabatan_lainnya" name="jabatan_lainnya" value="{{old('jabatan_lainnya')}}" autocomplete="off" />
                                                    </div>
                                                </div>
                                            </div>
                                            <!--end::Input-->
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-md-9 col-sm-12">
                                                    <div class="input-group date">
                                                        <input type="text" class="form-control" id="formasi" name="formasi" value="{{old('formasi')}}" autocomplete="off" />
                                                    </div>
                                                </div>
                                            </div>
                                            <!--end::Input-->
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-4 col-md-9 col-sm-12">
                                                    <div class="input-group date">
                                                        <input type="text" class="form-control" id="formasi_terisi_start" name="formasi_terisi_start" value="{{old('formasi_terisi_start')}}" autocomplete="off" />
                                                    </div>
                                                ...
                                                <div class="col-lg-4 col-md-9 col-sm-12">
                                                    <div class="input-group date">
                                                        <input type="text" class="form-control" id="formasi_terisi_end" name="formasi_terisi_end" value="{{old('formasi_terisi_end')}}" autocomplete="off" />
                                                    </div>
                                                </div>
                                            </div>
                                            <!--end::Input-->
                                        ...
                                        <!--end: Wizard Step 2-->
                                         ...
                                         <div class="pb-6" style="margin-left: 50px; margin-right: 50px;" data-wizard-type="step-content">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-md-9 col-sm-12">
                                                    <div class="input-group date">
                                                        <input type="text" class="form-control" id="no_surat_persetujuan" name="no_surat_persetujuan" value="{{old('no_surat_persetujuan')}}" autocomplete="off" />
                                                    </div>
                                                </div>
                                            </div>
                                            <!--end::Input-->
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-5 col-md-9 col-sm-12">
                                                    <div class="input-group date">
                                                        <input type="text" class="form-control datetimepicker-input my-datepicker" id="tanggal_surat_persetujuan" name="tanggal_surat_persetujuan" data-toggle="datetimepicker" data-target="#tanggal_surat_persetujuan" placeholder="Pilih Tanggal" value="{{old('tanggal_surat_persetujuan')}}" />
                                                        <div class="input-group-append">
                                                            <span class="input-group-text">
                                                                <i class="la la-calendar"></i>
                                                            </span>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-md-9 col-sm-12">
                                                    <div class="input-group date">
                                                    <input type="text"  class="form-control" id="kepada_menteri" name="kepada_menteri" value="{{old('kepada_menteri')}}" autocomplete="off" />
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-md-9 col-sm-12">
                                                    <div class="input-group date">
                                                        <input type="text"  class="form-control" id="nama_staff_khusus" name="nama_staff_khusus" value="{{old('nama_staff_khusus')}}" autocomplete="off" />
                                                    </div>
                                                </div>
                                            </div>
                                            <!--end::Input-->
