                                                                    ...
                                                                    <div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
                                                                        ...
                                                                        <div class="d-flex align-items-center mb-5 bg-light-warning rounded p-4">
                                                                            ...
                                                                            <div class="d-flex flex-column flex-grow-1 mr-2">
                                                                                <a href="{{ route('pic.pertek-bkn.kenaikan-pangkat.pemberian-kenaikan-pangkat.index') }}" class="font-weight-bold text-dark-75 text-hover-primary font-size-lg mb-1">Pemberian Kenaikan Pangkat</a>
                                                                            </div>
                                                                        </div>
                                                                        <div class="d-flex align-items-center mb-5 bg-light-success rounded p-4">
                                                                            ...
                                                                            <div class="d-flex flex-column flex-grow-1 mr-2">
                                                                                <a href="{{ route('pic.pertek-bkn.kenaikan-pangkat.pembatalan-keppres-kenaikan-pangkat.index') }}" class="font-weight-bold text-dark-75 text-hover-primary font-size-lg mb-1">Pembatalan Keppres Kenaikan Pangkat</a>
                                                                            </div>
                                                                        </div>
                                                                        <div class="d-flex align-items-center mb-5 bg-light-primary rounded p-4">
                                                                            ...
                                                                            <div class="d-flex flex-column flex-grow-1 mr-2">
                                                                                <a href="{{ route('pic.pertek-bkn.kenaikan-pangkat.pengesahan-kenaikan-pangkat.index') }}" class="font-weight-bold text-dark-75 text-hover-primary font-size-lg mb-1">Pengesahan Kenaikan Pangkat</a>
                                                                            </div>
                                                                        </div>
                                                                        <div class="d-flex align-items-center mb-5 bg-light-info rounded p-4">
                                                                            ...
                                                                            <div class="d-flex flex-column flex-grow-1 mr-2">
                                                                                <a href="{{ route('pic.pertek-bkn.kenaikan-pangkat.ralat-keppres-kepangkatan.index') }}" class="font-weight-bold text-dark-75 text-hover-primary font-size-lg mb-1">Ralat Keppres Kepangkatan</a>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </form>
