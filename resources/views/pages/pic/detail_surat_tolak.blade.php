                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="row py-10 px-8 py-lg-12 px-lg-10">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-5 col-md-9 col-sm-12">
                                                <div class="input-group date">
                                                    <input type="text" class="form-control datetimepicker-input my-datepicker" value="{{ $alasans->tanggal_prosess_penolakan }}" disabled/>
                                        ...
                                        <div class="form-group row ">
                                            ...
                                            <div class="col-lg-9 col-md-9 col-sm-12">
                                                <div class="input-group ">
                                                    <textarea class="form-control" rows="3" disabled>{{ $alasans->alasan_penolakan }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="mt-5 pt-10">
                                    <div class="mr-2">
                                        <a href="{{ route('pic.inbox.index') }}"type="button" class="btn btn-light-danger font-weight-bold">Batalkan</a>
                                    </div>
                                    <div>
                                    </div>
                                </div>
