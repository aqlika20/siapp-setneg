                                    ...
                                    <form class="form" id="kt_form" action="{{ route('pic.administrasi.surat-usulan.perpindahan-pejabat-fku.store') }}" enctype="multipart/form-data" method="POST">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-md-9 col-sm-12">
                                                    <div class="input-group">
                                                        <input type="text" class="form-control" id="req_no_surat_usulan" name="req_no_surat_usulan" value="{{old('req_no_surat_usulan')}}" autocomplete="off" onkeydown="return /[a-zA-Z0-9\s]+/i.test(event.key)" require/>
                                                    </div>
                                                </div>
                                            </div>
                                            <!--end::Input-->
                                        ...
                                        <div class="pb-6" style="margin-left: 50px; margin-right: 50px;" data-wizard-type="step-content">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-md-9 col-sm-12">
                                                    <div class="input-group date">
                                                        <input type="text" class="form-control" id="req_no_surat_rekomendasi" name="req_no_surat_rekomendasi" value="{{old('req_no_surat_rekomendasi')}}" autocomplete="off" onkeydown="return /[a-zA-Z0-9\s]+/i.test(event.key)" require/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-5 col-md-9 col-sm-12">
                                                    <div class="input-group date">
                                                    <input type="text" class="form-control datetimepicker-input my-datepicker" id="req_tgl_surat_rekomendasi" name="req_tgl_surat_rekomendasi" data-toggle="datetimepicker" data-target="#req_tgl_surat_rekomendasi" placeholder="Pilih Tanggal" value="{{old('req_tgl_surat_rekomendasi')}}" autocomplete="off" require />
                                                        <div class="input-group-append">
                                                            <span class="input-group-text">
                                                                <i class="la la-calendar"></i>
                                                            </span>
