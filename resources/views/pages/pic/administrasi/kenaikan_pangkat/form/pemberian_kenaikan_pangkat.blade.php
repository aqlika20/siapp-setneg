                        ...
                        <div class="wizard wizard-3" id="kt_wizard_v3" data-wizard-state="step-first" data-wizard-clickable="true">
                            ...
                            <div class="row justify-content-center py-10 px-8 py-lg-12 px-lg-10">
                                <div class="col-xl-20 col-xxl-12">
                                    <!--begin: Wizard Form-->
                                    <form class="form" id="kt_form" action="{{ route('pic.administrasi.kenaikan-pangkat.pemberian-kenaikan-pangkat.store') }}" enctype="multipart/form-data" method="POST">
                                        @csrf
                                        @method('PATCH')
                                        <!--begin: Wizard Step 1-->
                                        ...
                                        <div class="pb-6" style="margin-left: 50px; margin-right: 50px;" data-wizard-type="step-content">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-5 col-md-9 col-sm-12">
                                                    <div class="input-group date">
                                                        <input type="text" class="form-control datetimepicker-input my-datepicker" id="tmt_cpns" name="tmt_cpns" data-toggle="datetimepicker" data-target="#tmt_cpns" placeholder="Pilih Tanggal" value="{{old('tmt_cpns')}}" autocomplete="off" require />
                                                        <div class="input-group-append">
                                                            <span class="input-group-text">
                                                                <i class="la la-calendar"></i>
                                                            </span>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-5 col-md-9 col-sm-12">
                                                    <div class="input-group date">
                                                        <input type="text" class="form-control" id="masa_kerja_gol_tahun" name="masa_kerja_gol_tahun" value="{{old('masa_kerja_gol_tahun')}}" autocomplete="off" require />
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-5 col-md-9 col-sm-12">
                                                    <div class="input-group date">
                                                        <input type="text" class="form-control" id="masa_kerja_gol_bulan" name="masa_kerja_gol_bulan" value="{{old('masa_kerja_gol_bulan')}}" autocomplete="off" require />
                                            ...
                                            <div  id="otherFieldDiv">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9 col-md-9 col-sm-12">
                                                        <div class="input-group date">
                                                            <input type="text" class="form-control" id="no_klarifikasi_pak" name="no_klarifikasi_pak" value="{{old('no_klarifikasi_pak')}}" autocomplete="off"/>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-5 col-md-9 col-sm-12">
                                                        <div class="input-group date">
                                                            <input type="text" class="form-control datetimepicker-input my-datepicker" id="tanggal_klarifikasi_pak" name="tanggal_klarifikasi_pak" data-toggle="datetimepicker" data-target="#tanggal_klarifikasi_pak" placeholder="Pilih Tanggal" value="{{old('tanggal_klarifikasi_pak')}}" />
                                                            <div class="input-group-append">
                                                                <span class="input-group-text">
                                                                    <i class="la la-calendar"></i>
                                                                </span>
                                        ...
                                        <div class="pb-6" style="margin-left: 50px; margin-right: 50px;" data-wizard-type="step-content">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9">
                                                    <input id="file_sk_pangkat_terakhir" name="file_sk_pangkat_terakhir[]" type="file" class="file" data-show-preview="false" multiple autocomplete="off" require/>
                                        ...
                                        <div class="pb-6" style="margin-left: 50px; margin-right: 50px;" data-wizard-type="step-content">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-md-9 col-sm-12">
                                                    <select class="form-control select2" style="width: 230px;" id="pangkat_gol_baru" name="pangkat_gol_baru">
                                                        <option value="">Choose</option>
                                                        @foreach ($pangkats as $pangkat)
                                                            <option value="{{$pangkat->id}}" {{ old('pangkat_gol_baru') == $pangkat->id ? 'selected' : '' }}>{{$pangkat->name}}</option>
                                                        @endforeach
                                                    </select>
                                                    <!-- <div class="input-group date">
                                                        <select class="custom-select form-control">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-5 col-md-9 col-sm-12">
                                                    <div class="input-group date">
                                                        <input type="text" class="form-control" id="masa_kerja_gol_tahun_baru" name="masa_kerja_gol_tahun_baru" value="{{old('masa_kerja_gol_tahun_baru')}}" autocomplete="off" require/>
                                                        <label class="col-form-label text-left col-lg-3 col-sm-12">Tahun</label>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-5 col-md-9 col-sm-12">
                                                    <div class="input-group date">
                                                        <input type="text" class="form-control" id="masa_kerja_gol_bulan_baru" name="masa_kerja_gol_bulan_baru" value="{{old('masa_kerja_gol_bulan_baru')}}" autocomplete="off" require/>
                                                        <label class="col-form-label text-left col-lg-3 col-sm-12">Bulan</label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9">
                                                    <input id="file_sk_jabatan" name="file_sk_jabatan[]" type="file" class="file" data-show-preview="false" multiple require/>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9">
                                                    <input id="file_bap" name="file_bap[]" type="file" class="file" data-show-preview="false" multiple require/>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9">
                                                    <input id="file_spp" name="file_spp[]" type="file" class="file" data-show-preview="false" multiple require/>
                                            ...
                                            <div  id="otherJabatanPAKLainnya">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9 col-md-9 col-sm-12">
                                                        <div class="input-group date">
                                                            <input type="text" class="form-control" id="jataban_pak_lainnya" name="jataban_pak_lainnya" value="{{old('jataban_pak_lainnya')}}" autocomplete="off" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div  id="otherJabatanPAK">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9">
                                                        <input id="file_jabatan_pak_klarifikasi" name="file_jabatan_pak_klarifikasi[]" type="file" class="file" data-show-preview="false" multiple require/>
                                        ...
                                        <div class="pb-6" style="margin-left: 50px; margin-right: 50px;" data-wizard-type="step-content" data-wizard-state="current">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-md-9 col-sm-12">
                                                    <select class="form-control select22" style="width: 230px;" id="status_hukuman" name="status_hukuman">
                                                        <option value="">Choose</option>
                                                        <option value="1" {{ old('status_hukuman') ? 'selected' : '' }}>Pernah Dijatuhi Hukuman</option>
                                                        <option value="2" {{ old('status_hukuman') ? 'selected' : '' }}>Tidak Pernah Dijatuhi Hukuman</option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div id="pernah">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9">
                                                        <input id="file_hukuman" name="file_hukuman[]" type="file" class="file" data-show-preview="false" multiple require/>
                                            ...
                                            <div id="pangkatLuarBiasa">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9">
                                                        <input id="file_surat_keputusan_ppk" name="file_surat_keputusan_ppk[]" type="file" class="file" data-show-preview="false" multiple require/>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9">
                                                    <input id="file_skp_1_tahun_terakhir" name="file_skp_1_tahun_terakhir[]" type="file" class="file" data-show-preview="false" multiple require/>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9">
                                                    <input id="file_skp_2_tahun_terakhir" name="file_skp_2_tahun_terakhir[]" type="file" class="file" data-show-preview="false" multiple require/>
