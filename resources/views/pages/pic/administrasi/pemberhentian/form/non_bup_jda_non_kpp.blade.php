...
@section('content')
                        ...
                        <div class="wizard wizard-3" id="kt_wizard_v3" data-wizard-state="step-first" data-wizard-clickable="true">
                            ...
                            <div class="row justify-content-center py-10 px-8 py-lg-12 px-lg-10">
                                <div class="col-xl-20 col-xxl-12">
                                    <!--begin: Wizard Form-->
                                    <form class="form" id="kt_form" action="{{ route('pic.administrasi.pemberhentian.non-bup-jda-non-kpp.store') }}" enctype="multipart/form-data" method="POST">
                                        @csrf
                                        @method('PATCH')
                                        <!--begin: Wizard Step 1-->
    ...
    <!-- <input type="hidden" id="url-api-fetch-data-jda-bkn" name="url-api-fetch-data-jda-bkn" value="{{ route('api.bkn.fetch-data-jda') }}"/> -->
@endsection
