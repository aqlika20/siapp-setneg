                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach($pemberhentians as $pemberhentian)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="{{route('jf-ahli-pertama-pensiun.inbox.pemberhentian.verif', ['id' => $pemberhentian->id])}}" type="button" class="btn btn-success font-weight-bold align-items-md-end">Verifikasi</a>
                                                            </td>
                                                        </tr>
                                                    @endforeach
