        ...
        <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
            <div class="d-flex flex-column-fluid">
                ...
                <div class="container">
                    ...
                    <div class="card card-custom">
                        <div class="card-body">
                            <form method="POST" action="{{ route('karo.text-editor.pemberhentian.pertek.store') }}">
                            @csrf
                                <div class="tinymce">
                                    <input type="hidden" class="btn btn-warning font-weight-bolder text-uppercase px-9 py-4" name="v_id" value="{{ $pengangkatans->id }}">
                                    <input type="hidden" class="btn btn-warning font-weight-bolder text-uppercase px-9 py-4" name="v_id_usulan" value="{{ $pengangkatans->id_usulan }}">
                                    <input type="hidden" class="btn btn-warning font-weight-bolder text-uppercase px-9 py-4" name="v_jenis" value="{{ $pengangkatans->id_layanan }}">
                                    ...
                                    <textarea class="description" name="description">
                                        {!! $pengangkatans->description !!}
                                        <br>
                                        <br>
                                        
                                        <p>TTD Oleh:</p>
                                        <br>
                                        <img src="{{ url('/media/ttd/TTD.png') }}" title="TTD.png" width="108" height="90" alt="" data-mce-selected="1">
                                        <br>
