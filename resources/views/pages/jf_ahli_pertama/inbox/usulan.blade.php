                                                ...
                                                <tbody>
                                                    @foreach($pengangkatans as $pengangkatan)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="{{route('jf-ahli-pertama-p4.inbox.usulan.verif', ['id' => $pengangkatan->id])}}" type="button" class="btn btn-success font-weight-bold align-items-md-end">Verifikasi</a>
                                                            </td>
                                                        </tr>
                                                    @endforeach
                                                    ...
                                                    @foreach($pengangkatans_ns as $pengangkatan_ns)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="{{route('jf-ahli-pertama-p4.inbox.usulan.verif_ns', ['id' => $pengangkatan_ns->id])}}" type="button" class="btn btn-success font-weight-bold align-items-md-end">Verifikasi</a>
                                                            </td>
                                                        </tr>
                                                    @endforeach
                                                    ...
                                                    @foreach($lainnyas as $lainnya)
                                                        <tr>
                                                            ...
                                                            <td>{{ $lainnya->nama }}</td>
                                                            <td>
                                                                <a href="{{route('jf-ahli-pertama-p4.inbox.usulan.verif_lainnya', ['id' => $lainnya->id])}}" type="button" class="btn btn-success font-weight-bold align-items-md-end">Verifikasi</a>
                                                            </td>
                                                        </tr>
                                                    @endforeach
                                            ...
                                            <tbody>
                                                @foreach($jfku_pendings as $jfku_pending)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{route('jf-ahli-pertama.detail-surat-pengembalian.index', ['id' => $jfku_pending->id])}}" type="button" class="btn btn-warning btn-sm">
                                                                Lihat
                                                            </a>
                                                        </td>
                                                    </tr>
                                            ...
                                            <tbody>
                                                @foreach($jfku_tolaks as $jfku_tolak)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{route('jf-ahli-pertama.detail-surat-pengembalian-tolak.index', ['id' => $jfku_tolak->id])}}" type="button" class="btn btn-light-danger btn-sm">
                                                                Tolak
                                                            </a>
                                                        </td>
                                                    </tr>
