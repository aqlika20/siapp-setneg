                    ...
                    <div class="menu-submenu ">
                        ...
                        <ul class="menu-subnav">
                            ...
                            <li class="menu-item {{ (strpos($page_title, 'Super Admin | Administrasi | Jabatan Fungsional') !== false) ? 'menu-item-active' : '' }}" aria-haspopup="true">
                                <a href="{{ route('super-admin.administrasi.jabatan-fungsional.index') }}" class="menu-link "><i class="menu-bullet menu-bullet-line"><span></span></i><span class="menu-text">Jabatan Fungsional</span></a>
                            </li>
