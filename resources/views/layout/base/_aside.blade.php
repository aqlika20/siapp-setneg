...
{{-- Kemensetneg --}}
            @if ($currentUser->roles_id == 2) 
                <li class="menu-item {{ (strpos($page_title, 'KemenSetneg | Dashboard') !== false) ? 'menu-item-active' : '' }}" aria-haspopup="true">
                    <a href="{{ route('kemensetneg.home.index') }}" class="menu-link ">
                        <span class="svg-icon menu-icon"><!--begin::Svg Icon | path:media/svg/icons/Design/Layers.svg-->
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-house" viewBox="0 0 16 16">
                                <path fill-rule="evenodd" d="M2 13.5V7h1v6.5a.5.5 0 0 0 .5.5h9a.5.5 0 0 0 .5-.5V7h1v6.5a1.5 1.5 0 0 1-1.5 1.5h-9A1.5 1.5 0 0 1 2 13.5zm11-11V6l-2-2V2.5a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5z"/>
                                <path fill-rule="evenodd" d="M7.293 1.5a1 1 0 0 1 1.414 0l6.647 6.646a.5.5 0 0 1-.708.708L8 2.207 1.354 8.854a.5.5 0 1 1-.708-.708L7.293 1.5z"/>
                    ...
                    <div class="menu-submenu ">
                        ...
                        <ul class="menu-subnav">
                            ...
                            <li class="menu-item {{ (strpos($page_title, 'KemenSetneg | Inbox | JFKU') !== false) ? 'menu-item-active' : '' }}" aria-haspopup="true">
                                <a href="{{ route('kemensetneg.inbox.jfku.index') }}" class="menu-link "><i class="menu-bullet menu-bullet-line"><span></span></i><span class="menu-text">JFKU</span></a>
                            </li>
                            <li class="menu-item {{ (strpos($page_title, 'KemenSetneg | Inbox | Kenaikan Pangkat') !== false) ? 'menu-item-active' : '' }}" aria-haspopup="true">
                                <a href="{{ route('kemensetneg.inbox.kenaikan-pangkat.index') }}" class="menu-link "><i class="menu-bullet menu-bullet-line"><span></span></i><span class="menu-text">Kenaikan Pangkat</span></a>
                            </li>
                            <li class="menu-item {{ (strpos($page_title, 'KemenSetneg | Inbox | Pemberhentian') !== false) ? 'menu-item-active' : '' }}" aria-haspopup="true">
                                <a href="{{ route('kemensetneg.inbox.pemberhentian.index') }}" class="menu-link "><i class="menu-bullet menu-bullet-line"><span></span></i><span class="menu-text">Pemberhentian</span></a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li class="menu-item {{ (strpos($page_title, 'KemenSetneg | Atur Dokumen') !== false) ? 'menu-item-active' : '' }}" aria-haspopup="true">
                    <a href="{{ route('kemensetneg.atur-dokumen.index') }}" class="menu-link ">
                        <span class="svg-icon menu-icon"><!--begin::Svg Icon | path:media/svg/icons/Design/Layers.svg-->
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-mailbox" viewBox="0 0 16 16">
                                <path d="M4 4a3 3 0 0 0-3 3v6h6V7a3 3 0 0 0-3-3zm0-1h8a4 4 0 0 1 4 4v6a1 1 0 0 1-1 1H1a1 1 0 0 1-1-1V7a4 4 0 0 1 4-4zm2.646 1A3.99 3.99 0 0 1 8 7v6h7V7a3 3 0 0 0-3-3H6.646z"/>
                                <path d="M11.793 8.5H9v-1h5a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-1a.5.5 0 0 1-.354-.146l-.853-.854zM5 7c0 .552-.448 0-1 0s-1 .552-1 0a1 1 0 0 1 2 0z"/>
                ...
                <li class="menu-item {{ (strpos($page_title, 'KemenSetneg | Riwayat') !== false) ? 'menu-item-active' : '' }}" aria-haspopup="true">
                    <a href="{{ route('kemensetneg.riwayat.index') }}" class="menu-link ">
                        <span class="svg-icon menu-icon"><!--begin::Svg Icon | path:media/svg/icons/Design/Layers.svg-->
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-mailbox" viewBox="0 0 16 16">
                                <path d="M4 4a3 3 0 0 0-3 3v6h6V7a3 3 0 0 0-3-3zm0-1h8a4 4 0 0 1 4 4v6a1 1 0 0 1-1 1H1a1 1 0 0 1-1-1V7a4 4 0 0 1 4-4zm2.646 1A3.99 3.99 0 0 1 8 7v6h7V7a3 3 0 0 0-3-3H6.646z"/>
                                <path d="M11.793 8.5H9v-1h5a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-1a.5.5 0 0 1-.354-.146l-.853-.854zM5 7c0 .552-.448 0-1 0s-1 .552-1 0a1 1 0 0 1 2 0z"/>
                    ...
                    <div class="menu-submenu ">
                        ...
                        <ul class="menu-subnav">
                            ...
                            <li class="menu-item {{ (strpos($page_title, 'KemenSetneg | Setting | Supplier Definition') !== false) ? 'menu-item-active' : '' }}" aria-haspopup="true">
                                <a href="{{ route('kemensetneg.faq.index') }}" class="menu-link "><i class="menu-bullet menu-bullet-line"><span></span></i><span class="menu-text">FAQ</span></a>
                            </li>
                        </ul>
                    </div>
                </li>
...
{{-- Demo 3 --}}
            @if ($currentUser->roles_id == 3) 
                <li class="menu-item {{ (strpos($page_title, 'Demo 3 | Dashboard') !== false) ? 'menu-item-active' : '' }}" aria-haspopup="true">
                    <a href="{{ route('demo3.home.index') }}" class="menu-link ">
                        <span class="svg-icon menu-icon"><!--begin::Svg Icon | path:media/svg/icons/Design/Layers.svg-->
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-house" viewBox="0 0 16 16">
                                <path fill-rule="evenodd" d="M2 13.5V7h1v6.5a.5.5 0 0 0 .5.5h9a.5.5 0 0 0 .5-.5V7h1v6.5a1.5 1.5 0 0 1-1.5 1.5h-9A1.5 1.5 0 0 1 2 13.5zm11-11V6l-2-2V2.5a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5z"/>
                                <path fill-rule="evenodd" d="M7.293 1.5a1 1 0 0 1 1.414 0l6.647 6.646a.5.5 0 0 1-.708.708L8 2.207 1.354 8.854a.5.5 0 1 1-.708-.708L7.293 1.5z"/>
                ...
                <li class="menu-item {{ (strpos($page_title, 'Demo 3 | Inbox') !== false) ? 'menu-item-active' : '' }}" aria-haspopup="true">
                    <a href="{{ route('demo3.inbox.index') }}" class="menu-link ">
                        <span class="svg-icon menu-icon"><!--begin::Svg Icon | path:media/svg/icons/Design/Layers.svg-->
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-mailbox" viewBox="0 0 16 16">
                                <path d="M4 4a3 3 0 0 0-3 3v6h6V7a3 3 0 0 0-3-3zm0-1h8a4 4 0 0 1 4 4v6a1 1 0 0 1-1 1H1a1 1 0 0 1-1-1V7a4 4 0 0 1 4-4zm2.646 1A3.99 3.99 0 0 1 8 7v6h7V7a3 3 0 0 0-3-3H6.646z"/>
                                <path d="M11.793 8.5H9v-1h5a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-1a.5.5 0 0 1-.354-.146l-.853-.854zM5 7c0 .552-.448 0-1 0s-1 .552-1 0a1 1 0 0 1 2 0z"/>
                ...
                <li class="menu-item {{ (strpos($page_title, 'Demo 3 | Atur Dokument') !== false) ? 'menu-item-active' : '' }}" aria-haspopup="true">
                    <a href="{{ route('demo3.atur-dokument.index') }}" class="menu-link ">
                ...
                <li class="menu-item {{ (strpos($page_title, 'Demo 3 | Riwayat') !== false) ? 'menu-item-active' : '' }}" aria-haspopup="true">
                    <a href="{{ route('demo3.riwayat.index') }}" class="menu-link ">
                        <span class="svg-icon menu-icon"><svg xmlns="http://www.w3.org/2000/svg"  width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <div class="menu-submenu ">
                        ...
                        <ul class="menu-subnav">
                            ...
                            <li class="menu-item {{ (strpos($page_title, 'Demo 3 | Setting | FAQ') !== false) ? 'menu-item-active' : '' }}" aria-haspopup="true">
                                <a href="{{ route('demo3.pengaturan.faq') }}" class="menu-link "><i class="menu-bullet menu-bullet-line"><span></span></i><span class="menu-text">FAQ</span></a>
                            </li>
                        </ul>
                    </div>
                </li>
