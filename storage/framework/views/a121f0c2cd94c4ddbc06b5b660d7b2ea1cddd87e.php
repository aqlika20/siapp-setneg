                ...
                <div class="card card-custom">
                    <div class="card-header flex-wrap border-0 pt-6 pb-0" style="background-color: #FFA800;">
                        <div class="card-title">
                            <h3 class="card-label">Pemberhentian BUP Non KPP
                        ...
                        <div class="wizard wizard-3" id="kt_wizard_v3" data-wizard-state="step-first" data-wizard-clickable="true">
                            ...
                            <div class="row justify-content-center py-10 px-8 py-lg-12 px-lg-10">
                                <div class="col-xl-20 col-xxl-12">
                                    <!--begin: Wizard Form-->
                                    <form class="form" id="kt_form" action="<?php echo e(route('pic.administrasi.pemberhentian.bup-non-kpp.store')); ?>" enctype="multipart/form-data" method="POST">
                                        <?php echo csrf_field(); ?>
                                        ...
                                        <div class="pb-6" style="margin-left: 50px; margin-right: 50px;" data-wizard-type="step-content">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-md-9 col-sm-12">
                                                    <div class="input-group date">
                                                        <textarea type="text" class="form-control" id="alamat_setelah_pensiun" name="alamat_setelah_pensiun" value="<?php echo e(old('alamat_setelah_pensiun')); ?>" autocomplete="off" required></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-md-9 col-sm-12">
                                                    <div class="input-group date">
                                                        <textarea type="text" class="form-control" id="taspen" name="taspen" value="<?php echo e(old('taspen')); ?>" autocomplete="off" required></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                            ...
                                            <div  id="otherFieldDiv">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-lg-3 col-form-label">Upload Data Pak</label>
                                                    <div class="col-lg-9">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-lg-3 col-form-label">Upload Klarifikasi</label>
                                                    <div class="col-lg-9">
...
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project\siapp\resources\views/pages/pic/administrasi/pemberhentian/form/bup_non_kpp.blade.php ENDPATH**/ ?>