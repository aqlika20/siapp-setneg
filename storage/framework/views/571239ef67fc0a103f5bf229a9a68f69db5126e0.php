...
<?php $__env->startSection('content'); ?>
                                ...
                                <div class="card card-custom">
                                    ...
                                    <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4 my-2 my-md-0">
                                                            <div class="input-icon">
                                                                <input type="text" class="form-control" placeholder="Search PrO" id="production_batching_1_berita_acara_search_query" />
                                                                <span>
                                        ...
                                        <table class="datatable datatable-borderless" id="production_batching_1_berita_acara">
                                            <thead>
                                                <tr>
                                                    <th>#</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php if($proseq->id_status == Helper::$id_hold_batching_1): ?> 
                                                        <form id="form<?php echo e($num); ?>" method="POST" action="<?php echo e(route('production-batching-1.berita-acara.edit',[$berita->id])); ?>">
                                                            <?php echo csrf_field(); ?> 
                                                            ...
                                                            <a  title="Print" href="<?php echo e(route('production-batching-1.berita-acara.pdf',[$berita->id])); ?>" class="btn btn-icon btn-light btn-sm mx-1">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/pt_tigaraksa_satria/resources/views/pages/production_batching_1/berita_acara.blade.php ENDPATH**/ ?>