                                    ...
                                    <form class="form" id="kt_form" action="<?php echo e(route('pic.administrasi.surat-usulan.perpindahan-pejabat-fku.store')); ?>" enctype="multipart/form-data" method="POST">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-md-9 col-sm-12">
                                                    <div class="input-group">
                                                        <input type="text" class="form-control" id="req_no_surat_usulan" name="req_no_surat_usulan" value="<?php echo e(old('req_no_surat_usulan')); ?>" autocomplete="off" onkeydown="return /[a-zA-Z0-9\s]+/i.test(event.key)" require/>
                                                    </div>
                                                </div>
                                            </div>
                                            <!--end::Input-->
                                        ...
                                        <div class="pb-6" style="margin-left: 50px; margin-right: 50px;" data-wizard-type="step-content">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-md-9 col-sm-12">
                                                    <div class="input-group date">
                                                        <input type="text" class="form-control" id="req_instansi_induk" name="req_instansi_induk" value="<?php echo e(old('req_instansi_induk')); ?>" autocomplete="off" onkeydown="return /[a-zA-Z0-9\s]+/i.test(event.key)" require />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-md-9 col-sm-12">
                                                    <div class="input-group date">
                                                        <input type="text" class="form-control" id="req_instansi_pengusul" name="req_instansi_pengusul" value="<?php echo e(old('req_instansi_pengusul')); ?>" autocomplete="off" onkeydown="return /[a-zA-Z0-9\s]+/i.test(event.key)" require />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-md-9 col-sm-12">
                                                    <select class="form-control select2" style="width: 230px;" id="req_pangkat_gol" name="req_pangkat_gol">
                                                        ...
                                                        <?php $__currentLoopData = $pangkats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pangkat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($pangkat->id); ?>" <?php echo e(old('req_pangkat_gol') == $pangkat->id ? 'selected' : ''); ?>><?php echo e($pangkat->golongan); ?> | <?php echo e($pangkat->ruang); ?></option>
                                        ...
                                        <div class="pb-6" style="margin-left: 50px; margin-right: 50px;" data-wizard-type="step-content">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-md-9 col-sm-12">
                                                    <div class="input-group date">
                                                        <input type="text" class="form-control" id="req_no_sk_jabatan_lama" name="req_no_sk_jabatan_lama" value="<?php echo e(old('req_no_sk_jabatan_lama')); ?>" autocomplete="off" onkeydown="return /[a-zA-Z0-9\s]+/i.test(event.key)" require/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-5 col-md-9 col-sm-12">
                                                    <div class="input-group date">
                                                        <input type="text" class="form-control datetimepicker-input my-datepicker" id="req_tmt_jabatan_lama" name="req_tmt_jabatan_lama" data-toggle="datetimepicker" data-target="#req_tmt_jabatan_lama" placeholder="Pilih Tanggal" value="<?php echo e(old('req_tmt_jabatan_lama')); ?>" autocomplete="off" require />
                                                        <div class="input-group-append">
                                                            <span class="input-group-text">
                                                                <i class="la la-calendar"></i>
                                                            </span>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-md-9 col-sm-12">
                                                    <div class="input-group date">
                                                        <input type="text" class="form-control" id="req_unit_kerja_lama" name="req_unit_kerja_lama" value="<?php echo e(old('req_unit_kerja_lama')); ?>" autocomplete="off" require/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-lg-3 col-form-label">Upload/Download File</label>
                                                <div class="col-lg-9">
                                                    <input id="req_file_data_jabatan_lama" name="req_file_data_jabatan_lama[]" type="file" class="file" data-show-preview="false" multiple require/>
                                        ...
                                        <div class="pb-6" style="margin-left: 50px; margin-right: 50px;" data-wizard-type="step-content">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-md-9 col-sm-12">
                                                    <div class="input-group date">
                                                        <input type="text" class="form-control" id="req_unit_kerja_baru" name="req_unit_kerja_baru" value="<?php echo e(old('req_unit_kerja_baru')); ?>" autocomplete="off" require/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-lg-3 col-form-label">Upload/Download File</label>
                                                <div class="col-lg-9">
                                                    <input id="req_file_data_jabatan_baru" name="req_file_data_jabatan_baru[]" type="file" class="file" data-show-preview="false" multiple require/>
                                                    <!-- <div class="dropzone dropzone-multi" id="kt_dropzone_11">
                                                        <div class="dropzone-panel mb-lg-0 mb-2">
                                                            <a class="dropzone-select btn btn-light-primary font-weight-bold btn-sm">Attach files</a>
                                                            <a class="dropzone-upload btn btn-light-primary font-weight-bold btn-sm">Upload All</a>
                                        ...
                                        <div class="pb-6" style="margin-left: 50px; margin-right: 50px;" data-wizard-type="step-content">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-md-9 col-sm-12">
                                                    <div class="input-group date">
                                                        <input type="text" class="form-control" id="req_no_surat_rekomendasi" name="req_no_surat_rekomendasi" value="<?php echo e(old('req_no_surat_rekomendasi')); ?>" autocomplete="off" onkeydown="return /[a-zA-Z0-9\s]+/i.test(event.key)" require/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-5 col-md-9 col-sm-12">
                                                    <div class="input-group date">
                                                    <input type="text" class="form-control datetimepicker-input my-datepicker" id="req_tanggal_surat_rekomendasi" name="req_tanggal_surat_rekomendasi" data-toggle="datetimepicker" data-target="#req_tanggal_surat_rekomendasi" placeholder="Pilih Tanggal" value="<?php echo e(old('req_tanggal_surat_rekomendasi')); ?>" autocomplete="off" require />
                                                        <div class="input-group-append">
                                                            <span class="input-group-text">
                                                                <i class="la la-calendar"></i>
                                                            </span>
                                            ...
                                            <div class="form-group row">
                                                <label class="col-lg-3 col-form-label">Upload/Download File</label>
                                                <div class="col-lg-9">
                                                    <input id="req_file_data_rekomendasi" name="req_file_data_rekomendasi[]" type="file" class="file" data-show-preview="false" multiple require/>
                                                    <!-- <div class="dropzone dropzone-multi" id="kt_dropzone_11">
                                                        <div class="dropzone-panel mb-lg-0 mb-2">
                                                            <a class="dropzone-select btn btn-light-primary font-weight-bold btn-sm">Attach files</a>
                                                            <a class="dropzone-upload btn btn-light-primary font-weight-bold btn-sm">Upload All</a>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9">
                                                    <input id="req_file_surat_pernyataan_rekomendasi" name="req_file_surat_pernyataan_rekomendasi[]" type="file" class="file" data-show-preview="false" multiple require/>
                                                    <!-- <div class="dropzone dropzone-multi" id="kt_dropzone_11">
                                                        <div class="dropzone-panel mb-lg-0 mb-2">
                                                            <a class="dropzone-select btn btn-light-primary font-weight-bold btn-sm">Attach files</a>
                                                            <a class="dropzone-upload btn btn-light-primary font-weight-bold btn-sm">Upload All</a>
                                        ...
                                        <div class="pb-6" style="margin-left: 50px; margin-right: 50px;" data-wizard-type="step-content">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9">
                                                    <input id="req_file_skp_2_dukungan_lainnya" name="req_file_skp_2_dukungan_lainnya[]" type="file" class="file" data-show-preview="false" multiple require/>
                                                    <!-- <div class="dropzone dropzone-multi" id="kt_dropzone_11">
                                                        <div class="dropzone-panel mb-lg-0 mb-2">
                                                            <a class="dropzone-select btn btn-light-primary font-weight-bold btn-sm">Attach files</a>
                                                            <a class="dropzone-upload btn btn-light-primary font-weight-bold btn-sm">Upload All</a>
        ...
        $(function(){
            $('#kt_form').validate({
                ...
                rules:{
                    ...
                    req_file_data_jabatan_lama: {
                        extenstion: "jpg,png,jpeg,pdf"
                    },

                    req_jabatan_baru: 'required',
                    req_unit_kerja_baru: 'required',
                    req_file_data_jabatan_baru: {
                        extenstion: "jpg,png,jpeg,pdf"
                    },

                    req_no_surat_rekomendasi: 'required',
                    req_tanggal_surat_rekomendasi: 'required',
                    req_file_data_rekomendasi: {
                        extenstion: "jpg,png,jpeg,pdf"
                    },
                    req_file_surat_pernyataan_rekomendasi: {
                        extenstion: "jpg,png,jpeg,pdf"
                    },
                    ...
                    req_file_skp_2_dukungan_lainnya: {
                        extenstion: "jpg,png,jpeg,pdf"
                    }
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project\siapp\resources\views/pages/pic/pertek_bkn/surat_usulan/form/perpindahan_pejabat_fku.blade.php ENDPATH**/ ?>