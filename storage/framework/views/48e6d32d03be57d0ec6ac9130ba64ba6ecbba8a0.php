                ...
                <div class="container">
                    ...
                    <div class="card-header flex-wrap border-0 pt-6 pb-0" style="background-color: #FFA800;">
                        <div class="card-title">
                            <h3 class="card-label">Verifikasi JF Lainnya <?php echo e(Helper::defineJenisLayananBy($verifikasi_lainnya->jenis_layanan)); ?>
                                    ...
                                    <div class="col-xl-20 col-xxl-12">
                                        <!--begin: Wizard Form-->
                                            ...
                                            <div class="pb-6" style="margin-left: 50px; margin-right: 50px;" data-wizard-type="step-content">
                                                <?php if($verifikasi_lainnya->jenis_layanan == '10' || $verifikasi_lainnya->jenis_layanan == '11' || $verifikasi_lainnya->jenis_layanan == '12' || $verifikasi_lainnya->jenis_layanan == '14'): ?>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-md-9 col-sm-12">
                                                            <?php if($verifikasi_lainnya->file_surat_pengantar == null): ?>
                                                            <h1> - </h1>
                                                            <?php else: ?>
                                                            <table>
                                                                <thead>
                                                ...
                                                <?php if($verifikasi_lainnya->jenis_layanan == '12'): ?>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-5 col-md-9 col-sm-12">
                                                            <div class="input-group date">
                                                                <input type="text" class="form-control datetimepicker-input my-datepicker" value="<?php echo e($verifikasi_lainnya->tanggal_keppres); ?>" disabled/>
                                                                <div class="input-group-append">
                                                                    <span class="input-group-text">
                                                                        <i class="la la-calendar"></i>
                                                                    </span>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-md-9 col-sm-12">
                                                            <?php if($verifikasi_lainnya->file_keppres == null): ?>
                                                            <h1> - </h1>
                                                            <?php else: ?>
                                                            <table>
                                                                <thead>
                                                ...
                                                <?php if($verifikasi_lainnya->jenis_layanan == '14'): ?>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-md-9 col-sm-12">
                                                            <?php if($verifikasi_lainnya->file_dhr == null): ?>
                                                            <h1> - </h1>
                                                            <?php else: ?>
                                                            <table>
                                                                <thead>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-md-9 col-sm-12">
                                                            <?php if($verifikasi_lainnya->file_dukumen_lain_pengangkatan_lainnya == null): ?>
                                                            <h1> - </h1>
                                                            <?php else: ?>
                                                            <table>
                                                                <thead>
                                                                ...
                                                                <tbody>
                                                                    <?php $__currentLoopData = $file_dukumen_lain_pengangkatan_lainnyas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <tr>
                                                                        <td><a style="color: blue;" > <?php echo e($file); ?></a></td>
                                                                        <td><a id="d_file_dukumen_lain_pengangkatan_lainnya" type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#file_dukumen_lain_pengangkatan_lainnya_modal" data-file="<?php echo e($file); ?>">Lihat</a></td>
                                                                    </tr>
                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                </tbody>
                                                            </table>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9 col-md-9 col-sm-12">
                                                        <div class="input-group date">
                                                            <input type="text" class="form-control" value="<?php echo e($verifikasi_lainnya->alasan_ralat); ?>"  disabled/>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9 col-md-9 col-sm-12">
                                                        <?php if($verifikasi_lainnya->file_bukti_pendukung == null): ?>
                                                        <h1> - </h1>
                                                        <?php else: ?>
                                                        <table>
                                                            <thead>
                                                ...
                                                <?php if($verifikasi_lainnya->jenis_layanan == '13'): ?>
                                                ...
                                                <?php if($verifikasi_lainnya->jenis_layanan == '13'): ?>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-md-9 col-sm-12">
                                                            <?php if($verifikasi_lainnya->file_ba_pelantikan == null): ?>
                                                            <h1> - </h1>
                                                            <?php else: ?>
                                                            <table>
                                                                <thead>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-md-9 col-sm-12">
                                                            <?php if($verifikasi_lainnya->file_sumpah_jabatan == null): ?>
                                                            <h1> - </h1>
                                                            <?php else: ?>
                                                            <table>
                                                                <thead>
                                            ...
                                            <div class="d-flex justify-content-between mt-5 pt-10" style="margin-left: 50px; margin-right: 50px;">
                                                ...
                                                <div>
                                                    <table>
                                                        ...
                                                        <th style="margin-right: 10px;">
                                                            <form method="POST" action="<?php echo e(route('koor-pokja.inbox.lainnya.store_proses')); ?>">
                                                                <?php echo csrf_field(); ?> 
                                                        ...
                                                        <th style="margin-right: 10px;">
                                                            <form method="POST" action="<?php echo e(route('koor-pokja.inbox.lainnya.store_pending')); ?>">
                                                                <?php echo csrf_field(); ?> 
                                                                <input type="hidden" class="btn btn-warning font-weight-bolder text-uppercase px-9 py-4" name="v_id" value="<?php echo e($verifikasi_lainnya->id); ?>">
                                                                <input type="hidden" class="btn btn-warning font-weight-bolder text-uppercase px-9 py-4" name="v_jenis" value="<?php echo e($verifikasi_lainnya->jenis_layanan); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project\siapp\resources\views/pages/koor_pokja/inbox/verif_lainnya.blade.php ENDPATH**/ ?>