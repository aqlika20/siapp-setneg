                            ...
                            <table class="datatable cell-border" id="tb_administrasi">
                                ...
                                <?php $__currentLoopData = $rkps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rkp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo e(route('deputi.inbox.detail.pertek', ['id' => $rkp->id])); ?>" type="button" class="btn btn-success btn-xs">
												Detail
											</a>
                                        </td>
                                    </tr>
...
<?php $__env->stopSection(); ?> 
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project\siapp\resources\views/pages/deputi/inbox/pertek_bkn.blade.php ENDPATH**/ ?>