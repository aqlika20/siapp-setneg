                                    ...
                                    <form class="form" id="kt_form" action="<?php echo e(route('pic.administrasi.surat-usulan.persetujuan-pengangkatan-staf-khusus.store')); ?>" enctype="multipart/form-data" method="POST">
                                        ...
                                        <div class="pb-6" style="margin-left: 50px; margin-right: 50px;" data-wizard-type="step-content">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-md-9 col-sm-12">
                                                    <div class="input-group date">
                                                        <input type="text" class="form-control" id="jabatan_lainnya" name="jabatan_lainnya" value="<?php echo e(old('jabatan_lainnya')); ?>" autocomplete="off" required/>
                                                    </div>
                                                </div>
                                            </div>
                                            <!--end::Input-->
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-md-9 col-sm-12">
                                                    <div class="input-group date">
                                                        <input type="text" class="form-control" id="formasi" name="formasi" value="<?php echo e(old('formasi')); ?>" autocomplete="off" required/>
                                                    </div>
                                                </div>
                                            </div>
                                            <!--end::Input-->
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-4 col-md-9 col-sm-12">
                                                    <div class="input-group date">
                                                        <input type="text" class="form-control" id="formasi_terisi_start" name="formasi_terisi_start" value="<?php echo e(old('formasi_terisi_start')); ?>" autocomplete="off" required/>
                                                    </div>
                                                ...
                                                <div class="col-lg-4 col-md-9 col-sm-12">
                                                    <div class="input-group date">
                                                        <input type="text" class="form-control" id="formasi_terisi_end" name="formasi_terisi_end" value="<?php echo e(old('formasi_terisi_end')); ?>" autocomplete="off" required/>
                                                    </div>
                                                </div>
                                            </div>
                                            <!--end::Input-->
                                        ...
                                        <!--end: Wizard Step 2-->
                                         ...
                                         <div class="pb-6" style="margin-left: 50px; margin-right: 50px;" data-wizard-type="step-content">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-md-9 col-sm-12">
                                                    <div class="input-group date">
                                                        <input type="text" class="form-control" id="no_surat_persetujuan" name="no_surat_persetujuan" value="<?php echo e(old('no_surat_persetujuan')); ?>" autocomplete="off" required/>
                                                    </div>
                                                </div>
                                            </div>
                                            <!--end::Input-->
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-5 col-md-9 col-sm-12">
                                                    <div class="input-group date">
                                                        <input type="text" class="form-control datetimepicker-input my-datepicker" id="tanggal_surat_persetujuan" name="tanggal_surat_persetujuan" data-toggle="datetimepicker" data-target="#tanggal_surat_persetujuan" placeholder="Pilih Tanggal" value="<?php echo e(old('tanggal_surat_persetujuan')); ?>" required/>
                                                        <div class="input-group-append">
                                                            <span class="input-group-text">
                                                                <i class="la la-calendar"></i>
                                                            </span>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-md-9 col-sm-12">
                                                    <div class="input-group date">
                                                    <input type="text" onkeydown="return /[a-zA-Z0-9\s]+/i.test(event.key)" class="form-control" id="kepada_menteri" name="kepada_menteri" value="<?php echo e(old('kepada_menteri')); ?>" autocomplete="off" required/>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-md-9 col-sm-12">
                                                    <div class="input-group date">
                                                        <input type="text" onkeydown="return /[a-zA-Z0-9\s]+/i.test(event.key)" class="form-control" id="nama_staff_khusus" name="nama_staff_khusus" value="<?php echo e(old('nama_staff_khusus')); ?>" autocomplete="off" required/>
                                                    </div>
                                                </div>
                                            </div>
                                            <!--end::Input-->
