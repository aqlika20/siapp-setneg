                                    ...
                                    <form class="form" id="kt_form" action="<?php echo e(route('pic.administrasi.pemberhentian.pembatalan-keppres-pemberhentian.store')); ?>" enctype="multipart/form-data" method="POST">
                                        ...
                                        <div class="pb-6" style="margin-left: 50px; margin-right: 50px;" data-wizard-type="step-content">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-md-9 col-sm-12">
                                                    <div class="input-group">
                                                        <input type="number" class="form-control" id="nomor_keppres_dibatalkan" name="nomor_keppres_dibatalkan" value="<?php echo e(old('nomor_keppres_dibatalkan')); ?>" autocomplete="off" require/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-md-9 col-sm-12">
                                                    <div class="input-group">
                                                        <input type="text" class="form-control" id="no_urut" name="no_urut" value="<?php echo e(old('no_urut')); ?>" autocomplete="off" require/>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
