                        ...
                        <div class="card-body">
                            <div class="row justify-content-center py-10 px-8 py-lg-12 px-lg-10">
                                <div class="col-xl-20 col-xxl-12">
                                    <!--begin: Wizard Form-->
                                    <form method="POST" action="<?php echo e(route('dukmin.inbox.keppres-store')); ?>" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?> 
                                        ...
                                        <div class="pb-6">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-5 col-md-9 col-sm-12">
                                                    <div class="input-group date">
                                                        <input type="text" class="form-control" value="<?php echo e(Helper::converttanggal($rkps->tanggal_keppres_maju)); ?>" disabled/>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-5 col-md-9 col-sm-12">
                                                    <div class="input-group date">
                                                        <input type="text" class="form-control datetimepicker-input my-datepicker" id="tanggal_keppres_turun" name="tanggal_keppres_turun" data-toggle="datetimepicker" data-target="#tanggal_keppres_turun" placeholder="Pilih Tanggal" value="<?php echo e(old('tanggal_keppres_turun')); ?>" autocomplete="off" required/>
                                                        <div class="input-group-append">
                                                            <span class="input-group-text">
                                                                <i class="la la-calendar"></i>
                                                            </span>
...
<?php $__env->stopSection(); ?> 
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project\siapp\resources\views/pages/dukmin/inbox/keppres_turun.blade.php ENDPATH**/ ?>