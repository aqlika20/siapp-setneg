                                ...
                                <?php $__currentLoopData = $rkps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rkp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?php echo e(route('tu-menteri.inbox.detail.pertek', ['id' => $rkp->id])); ?>" type="button" class="btn btn-success btn-xs">
												Detail
											</a>
                                            <?php elseif($rkp->status == Helper::$verifikasi_rkp_tu_kementerian): ?>
                                            <a href="<?php echo e(route('tu-menteri.inbox.keppres-maju', ['id' => $rkp->id])); ?>" type="button" class="btn btn-success btn-xs">
											    Keppres Maju
											</a>
                                            <?php endif; ?>
                                        </td>
...
<?php $__env->stopSection(); ?> 
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project\siapp\resources\views/pages/tu_kementerian/inbox/pertek_bkn.blade.php ENDPATH**/ ?>