                                                ...
                                                <tbody>
                                                    <?php $__currentLoopData = $pengangkatans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pengangkatan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="<?php echo e(route('koor-pokja-kp.inbox.kenaikan_pangkat.verif', ['id' => $pengangkatan->id])); ?>"><i class="fa fa-pencil-alt text-success mr-2"></i></a>
                                                                <a href="<?php echo e(route('koor-pokja-kp.inbox.distributor.index', ['id' => $pengangkatan->id, 'jenis_layanan' => $pengangkatan->jenis_layanan])); ?>"><i class="fa fa-share text-info mr-1"></i></a>
                                                            </td>
                                                        </tr>
                                            ...
                                            <tbody>
                                                <?php $__currentLoopData = $kenaikan_pendings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kenaikan_pending): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo e(route('koor-pokja-kp.inbox.detail-surat-pengembalian.index', ['id' => $kenaikan_pending->id])); ?>" type="button" class="btn btn-warning btn-sm">
                                                                Lihat
                                                            </a>
                                                        </td>
                                                    </tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ardim\Desktop\siapp2\siapp\resources\views/pages/koor_pokja_kp/inbox/kenaikan_pangkat.blade.php ENDPATH**/ ?>