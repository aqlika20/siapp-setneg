                                            ...
                                            <tbody>
                                                <?php $__currentLoopData = $jfku_tolaks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jfku_tolak): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo e(route('jf-ahli.detail-surat-pengembalian-tolak.index', ['id' => $jfku_tolak->id])); ?>" type="button" class="btn btn-light-danger btn-sm">
                                                                Tolak
                                                            </a>
                                                        </td>
                                                    </tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project\siapp\resources\views/pages/jf_ahli/inbox/usulan.blade.php ENDPATH**/ ?>