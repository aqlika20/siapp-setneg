                                    ...
                                    <form class="form" id="kt_form" action="<?php echo e(route('super-admin.administrasi.surat-usulan.pengangkatan-pejabat-fku.store')); ?>" enctype="multipart/form-data" method="POST">
                                        ...
                                        <div class="pb-6" data-wizard-type="step-content">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-md-9 col-sm-12">
                                                    <div class="input-group date">
                                                        <input type="text" class="form-control" id="req_no_sk_jabatan_lama" name="req_no_sk_jabatan_lama" value="<?php echo e(old('req_no_sk_jabatan_lama')); ?>" autocomplete="off" require/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                        ...
                                        <div class="pb-6" data-wizard-type="step-content">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-md-9 col-sm-12">
                                                    <div class="input-group date">
                                                        <input type="text" class="form-control" id="req_no_sertifikat" name="req_no_sertifikat" value="<?php echo e(old('req_no_sertifikat')); ?>" autocomplete="off" require/>
                                                    </div>
                                                </div>
                                            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ardim\Desktop\siapp jadi\siapp\resources\views/pages/super_admin/administrasi/surat_usulan/form/pengangkatan_pejabat_fku.blade.php ENDPATH**/ ?>