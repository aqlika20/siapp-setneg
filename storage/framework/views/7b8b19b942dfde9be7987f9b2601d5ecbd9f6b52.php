                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4 my-2 my-md-0">
                                                            <div class="input-icon">
                                                                <input type="text" class="form-control" placeholder="Search Batch No" id="filling_report_search_query" />
                                                                <span>
                                            ...
                                            <div class="dropdown dropdown-inline mr-2">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                                    ...
                                                    <ul class="navi flex-column navi-hover py-2">
                                                        ...
                                                        <li class="navi-item">
                                                            <a href="<?php echo e(route('filling.report.excel')); ?>" class="navi-link">
                                                        ...
                                                        <li class="navi-item">
                                                            <a href="<?php echo e(route('filling.report.pdf')); ?>" class="navi-link">
                                                                <span class="navi-icon">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/pt_tigaraksa_satria/resources/views/pages/filling/report.blade.php ENDPATH**/ ?>