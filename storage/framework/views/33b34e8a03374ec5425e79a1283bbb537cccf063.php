...
<?php $__env->startSection('content'); ?>
                                ...
                                <div class="card card-custom">
                                    ...
                                    <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4 my-2 my-md-0">
                                                            <div class="input-icon">
                                                                <input type="text" class="form-control" placeholder="Search Email" id="super_admin_user_management_search_query" />
                                                                <span>
                                                        ...
                                                        <div class="col-md-4 my-2 my-md-0">
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <select class="form-control" id="super_admin_user_management_search_role">
                                                                    ...
                                                                    <option value="5">Production - Batching 1</option>
                                                                    <option value="6">Production - Batching 2</option>
                                                                    <option value="7">Filling</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <!--end: Search Form-->
                                        <!--begin: Datatable-->
                                        <table class="datatable datatable-borderless" id="super_admin_user_management">
                                            <thead>
                                                <tr>
...
unset($__errorArgs, $__bag); ?>" name="email" required autocomplete="email" autofocus>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <input id="password" type="password" minlength="8" class="form-control <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="password" required autocomplete="new-password" autofocus>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="roles_id" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Role')); ?></label>
...
<script>
    $('#super_admin_user_management_search_role').select2();
    $('#roles_id').select2();
</script>

<script src="<?php echo e(asset('js/pages/crud/ktdatatable/base/html-table.js')); ?>" type="text/javascript"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/pt_tigaraksa_satria/resources/views/pages/super_admin/user_management.blade.php ENDPATH**/ ?>