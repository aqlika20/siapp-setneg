                                                                ...
                                                                <form class="form" id="kt_form">
                                                                    ...
                                                                    <div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
                                                                        ...
                                                                        <div class="d-flex align-items-center mb-5 bg-light-danger rounded p-4">
                                                                            ...
                                                                            <!--begin::Title-->
                                                                            <div class="d-flex flex-column flex-grow-1 mr-2">
                                                                                <a href="<?php echo e(route('pic.administrasi.pemberhentian.petikan-keppres-yang-hilang.index')); ?>" class="font-weight-bold text-dark-75 text-hover-primary font-size-lg mb-1">Legalisir Petikan Keputusan Presiden yang Hilang atau Rusak</a>
                                                                            </div>
                                                                            <!--end::Title-->
                                                                            <!--begin::Lable-->
                                                                            <!--end::Lable-->
