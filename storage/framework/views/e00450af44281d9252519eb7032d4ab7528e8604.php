        ...
        <?php if(config('layout.extras.user.layout') == 'offcanvas'): ?>
            <div class="topbar-item">
                <div class="btn btn-icon w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
                    ...
                    <span class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3 text-capitalize"><?php echo e($currentUser->name); ?></span>
...
<?php /**PATH C:\Users\ardim\Desktop\siapp jadi\siapp\resources\views/layout/partials/extras/_topbar.blade.php ENDPATH**/ ?>