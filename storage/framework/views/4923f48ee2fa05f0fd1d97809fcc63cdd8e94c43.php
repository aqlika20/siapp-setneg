                                    ...
                                    <form class="form" id="kt_form" action="<?php echo e(route('super-admin.administrasi.surat-usulan.perpindahan-pejabat-fku.store')); ?>" enctype="multipart/form-data" method="POST">
                                        ...
                                        <div class="pb-6" data-wizard-type="step-content">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-5 col-md-9 col-sm-12">
                                                    <div class="input-group date">
                                                        <input type="text" class="form-control datetimepicker-input my-datepicker" id="req_tlg_surat_rekomendasi" name="req_tlg_surat_rekomendasi" data-toggle="datetimepicker" data-target="#1" placeholder="Pilih Tanggal" value="<?php echo e(old('req_tmt_jabatan')); ?>" autocomplete="off" require />
                                                        <div class="input-group-append">
                                                            <span class="input-group-text">
                                                                <i class="la la-calendar"></i>
                                                            </span>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ardim\Desktop\siapp jadi\siapp\resources\views/pages/super_admin/administrasi/surat_usulan/form/perpindahan_pejabat_fku.blade.php ENDPATH**/ ?>