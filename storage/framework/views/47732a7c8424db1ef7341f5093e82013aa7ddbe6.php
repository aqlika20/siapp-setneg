        ...
        <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
            <div class="d-flex flex-column-fluid">
                ...
                <div class="container">
                    ...
                    <div class="card card-custom">
                        <div class="card-body">
                            <form method="POST" action="<?php echo e(route('koor-pokja.inbox.text-editor.store')); ?>">
                            <?php echo csrf_field(); ?>
                                <div class="tinymce">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project\siapp\resources\views/pages/koor_pokja/inbox/text_editor_inbox_pending.blade.php ENDPATH**/ ?>