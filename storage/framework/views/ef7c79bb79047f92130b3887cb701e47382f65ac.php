                                        ...
                                        <div class="pb-6" style="margin-left: 50px; margin-right: 50px;" data-wizard-type="step-content">
                                            ...
                                            <div  id="otherFieldDiv">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9 col-md-9 col-sm-12">
                                                        <div class="input-group date">
                                                            <input type="text" class="form-control" id="req_no_klarifikasi_pak" name="req_no_klarifikasi_pak" value="<?php echo e(old('req_no_klarifikasi_pak')); ?>" autocomplete="off"/>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-5 col-md-9 col-sm-12">
                                                        <div class="input-group date">
                                                            <input type="text" class="form-control datetimepicker-input my-datepicker" id="req_tanggal_klarifikasi_pak" name="req_tanggal_klarifikasi_pak" data-toggle="datetimepicker" data-target="#req_tanggal_klarifikasi_pak" placeholder="Pilih Tanggal" value="<?php echo e(old('req_tanggal_klarifikasi_pak')); ?>" />
                                                            <div class="input-group-append">
                                                                <span class="input-group-text">
                                                                    <i class="la la-calendar"></i>
                                                                </span>
                                        ...
                                        <div class="pb-6" style="margin-left: 50px; margin-right: 50px;" data-wizard-type="step-content">
                                            ...
                                            <div  id="otherJabatanPAKLainnya">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9 col-md-9 col-sm-12">
                                                        <div class="input-group date">
                                                            <input type="text" class="form-control" id="req_jataban_pak_lainnya" name="req_jataban_pak_lainnya" value="<?php echo e(old('req_jataban_pak_lainnya')); ?>" autocomplete="off" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-md-9 col-sm-12">
                                                    <select class="form-control select22" style="width: 230px;" id="req_status_hukuman" name="req_status_hukuman">
                                                        <option value="">Choose</option>
                                                        <option value="1" <?php echo e(old('req_status_hukuman') ? 'selected' : ''); ?>>Pernah Dijatuhi Hukuman</option>
                                                        <option value="2" <?php echo e(old('req_status_hukuman') ? 'selected' : ''); ?>>Tidak Pernah Dijatuhi Hukuman</option>
                                                    </select>
                                                </div>
                                            </div>
