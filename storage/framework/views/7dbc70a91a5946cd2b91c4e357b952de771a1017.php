                                                                ...
                                                                <form class="form" id="kt_form">
                                                                    ...
                                                                    <div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
                                                                        ...
                                                                        <div class="d-flex align-items-center mb-5 bg-light-warning rounded p-4">
                                                                            ...
                                                                            <div class="d-flex flex-column flex-grow-1 mr-2">
                                                                                <a href="<?php echo e(route('koor-pokja.inbox.pengangkatan-pejabat-ns.index')); ?>" class="font-weight-bold text-dark-75 text-hover-primary font-size-lg mb-1">Pengangkatan Pejabat Non Struktural dan Pejabat Lainnya</a>
                                                                            </div>
                                                                            <!--end::Title-->
                                                                            <!--begin::Lable-->
                                                                            <!--end::Lable-->
                                                                        ...
                                                                        <div class="d-flex align-items-center mb-5 bg-light-success rounded p-4">
                                                                            ...
                                                                            <!--begin::Title-->
                                                                            <div class="d-flex flex-column flex-grow-1 mr-2">
                                                                                <a href="<?php echo e(route('koor-pokja.inbox.pemberhentian-pejabat-ns.index')); ?>" class="font-weight-bold text-dark-75 text-hover-primary font-size-lg mb-1">Pemberhentian Pejabat Non Struktural dan Pejabat Lainnya</a>
                                                                            </div>
                                                                            <!--end::Title-->
                                                                            <!--begin::Lable-->
                                                                            <!--end::Lable-->
                                                                        ...
                                                                        <div class="d-flex align-items-center mb-5 bg-light-primary rounded p-4">
                                                                            ...
                                                                            <!--begin::Title-->
                                                                            <div class="d-flex flex-column flex-grow-1 mr-2">
                                                                                <a href="<?php echo e(route('koor-pokja.inbox.ralat-keppres-jabatan-ns.index')); ?>" class="font-weight-bold text-dark-75 text-hover-primary font-size-lg mb-1">Perpanjangan Pejabat Non Struktural dan Pejabat Lainnya</a>
                                                                            </div>
                                                                            <!--end::Title-->
                                                                            <!--begin::Lable-->
                                                                            <!--end::Lable-->
                                                                        ...
                                                                        <div class="d-flex align-items-center mb-5 bg-light-primary rounded p-4">
                                                                            ...
                                                                            <!--begin::Title-->
                                                                            <div class="d-flex flex-column flex-grow-1 mr-2">
                                                                                <a href="<?php echo e(route('koor-pokja.inbox.pembatalan-keppres-jabatan-ns.index')); ?>" class="font-weight-bold text-dark-75 text-hover-primary font-size-lg mb-1">Usulan Lainnya Non Struktural dan Pejabat Lainnya</a>
                                                                            </div>
                                                                            <!--end::Title-->
                                                                            <!--begin::Lable-->
                                                                            <!--end::Lable-->
                                                                    ...
                                                                    <div class="pb-5" data-wizard-type="step-content">
                                                                        ...
                                                                        <div class="d-flex align-items-center mb-5 bg-light-success rounded p-4">
                                                                            ...
                                                                            <!--begin::Title-->
                                                                            <div class="d-flex flex-column flex-grow-1 mr-2">
                                                                                <a href="<?php echo e(route('koor-pokja.inbox.persetujuan-pengangkatan-staf-khusus.index')); ?>" class="font-weight-bold text-dark-75 text-hover-primary font-size-lg mb-1">Persetujuan pengangkatan Staf Khusus Menteri/Kepala Lembaga</a>
                                                                        ...
                                                                        <div class="d-flex align-items-center mb-5 bg-light-success rounded p-4">
                                                                            ...
                                                                            <!--begin::Title-->
                                                                            <div class="d-flex flex-column flex-grow-1 mr-2">
                                                                                <a href="<?php echo e(route('koor-pokja.inbox.persetujuan-pengangkatan-staf-khusus.index')); ?>" class="font-weight-bold text-dark-75 text-hover-primary font-size-lg mb-1">Laporan Pemberhentian</a>
                                                                            </div>
                                                                            <!--end::Title-->
                                                                        </div>
                                                                        <!--end::Select-->
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ardim\Desktop\siapp2\siapp\resources\views/pages/koor_pokja/inbox/lns.blade.php ENDPATH**/ ?>