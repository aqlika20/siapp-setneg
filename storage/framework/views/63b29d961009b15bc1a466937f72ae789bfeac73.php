                                ...
                                <div class="wizard wizard-3" id="kt_wizard_v3" data-wizard-state="step-first" data-wizard-clickable="true">
                                    <div class="row justify-content-center py-10 px-8 py-lg-12 px-lg-10">
                                        <div class="col-xl-20 col-xxl-12">
                                            <form class="form" id="test_callbackform" action="<?php echo e(route('koor-pokja.inbox.jfku.store_tolak')); ?>" enctype="multipart/form-data" method="POST">
                                                <?php echo csrf_field(); ?> 
											...
											<div class="d-flex justify-content-between mt-5 pt-10" style="margin-left: 50px; margin-right: 50px;">
												<form method="POST" action="<?php echo e(route('koor-pokja.inbox.jfku.tolak_text_editor')); ?>">
													<?php echo csrf_field(); ?> 
													<input type="hidden" class="btn btn-warning font-weight-bolder text-uppercase px-9 py-4" name="v_id" value="<?php echo e($pengangkatans->id); ?>">
													<input type="hidden" class="btn btn-warning font-weight-bolder text-uppercase px-9 py-4" name="v_jenis" value="<?php echo e($pengangkatans->jenis_layanan); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/siapp/resources/views/pages/koor_pokja/inbox/text_editor_inbox_tolak.blade.php ENDPATH**/ ?>