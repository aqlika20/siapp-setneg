                                                                ...
                                                                <form class="form" id="kt_form">
                                                                    ...
                                                                    <div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
                                                                        ...
                                                                        <div class="d-flex align-items-center mb-5 bg-light-danger rounded p-4">
                                                                            ...
                                                                            <!--begin::Title-->
                                                                            <div class="d-flex flex-column flex-grow-1 mr-2">
                                                                                <a href="<?php echo e(route('pic.administrasi.pemberhentian.masa-persiapan-pensiun.index')); ?>" class="font-weight-bold text-dark-75 text-hover-primary font-size-lg mb-1">Masa Persiapan Pensiun</a>
                                                                            </div>
                                                                            <!--end::Title-->
                                                                            <!--begin::Lable-->
                                                                            <!--end::Lable-->
                                                                        ...
                                                                        <div class="d-flex align-items-center mb-5 bg-light-danger rounded p-4">
                                                                            ...
                                                                            <!--begin::Title-->
                                                                            <div class="d-flex flex-column flex-grow-1 mr-2">
                                                                                <a href="<?php echo e(route('pic.administrasi.pemberhentian.permasalahan-kepegawaian-lainnya.index')); ?>" class="font-weight-bold text-dark-75 text-hover-primary font-size-lg mb-1">Permasalahan Kepegawaian Lainnya</a>
                                                                            </div>
                                                                            <!--end::Title-->
                                                                            <!--begin::Lable-->
                                                                            <!--end::Lable-->
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ardim\Desktop\siapp2\siapp\resources\views/pages/pic/administrasi/pemberhentian/pemberhentian.blade.php ENDPATH**/ ?>