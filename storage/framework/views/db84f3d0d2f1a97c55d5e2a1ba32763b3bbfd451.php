                                                ...
                                                <tbody>
                                                    <?php $__currentLoopData = $pengangkatans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pengangkatan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo e($pengangkatan->instansi_induk); ?></td>
                                                            ...
                                                            <td>
                                                                <a href="<?php echo e(route('koor-pokja-pensiun.inbox.pemberhentian.verif', ['id' => $pengangkatan->id])); ?>"><i class="fa fa-pencil-alt text-success mr-2"></i></a>
                                                                <a href="<?php echo e(route('koor-pokja-pensiun.inbox.distributor.index', ['id' => $pengangkatan->id, 'jenis_layanan' => $pengangkatan->jenis_layanan])); ?>"><i class="fa fa-share text-info mr-1"></i></a>
                                                            </td>
                                                        </tr>
                                                ...
                                                <tbody>
                                                    <?php $__currentLoopData = $pemberhentian_pendings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pemberhentian_pending): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo e($pemberhentian_pending->instansi_induk); ?></td>
                                                            ...
                                                            <td>
                                                                <a href="<?php echo e(route('koor-pokja-pensiun.inbox.detail-surat-pengembalian.index', ['id' => $pemberhentian_pending->id])); ?>" type="button" class="btn btn-warning btn-sm">
                                                                    Lihat
                                                                </a>
                                                            </td>
                                                        </tr>
                                                ...
                                                <tbody>
                                                    <?php $__currentLoopData = $jfku_tolaks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jfku_tolak): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo e($jfku_tolak->instansi_induk); ?></td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project\siapp\resources\views/pages/koor_pokja_pensiun/inbox/pemberhentian.blade.php ENDPATH**/ ?>