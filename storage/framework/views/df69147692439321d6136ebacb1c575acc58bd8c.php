                                                                ...
                                                                <form class="form" id="kt_form">
                                                                    <div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
                                                                        ...
                                                                        <div class="d-flex align-items-center mb-5 bg-light-warning rounded p-4">
                                                                            ...
                                                                            <div class="d-flex flex-column flex-grow-1 mr-2">
                                                                                <a href="<?php echo e(route('pic.pertek-bkn.surat-usulan.pengangkatan-pejabat-fku.index')); ?>" class="font-weight-bold text-dark-75 text-hover-primary font-size-lg mb-1">Pengangkatan Pejabat Fungsional Keahlian Utama</a>
                                                                            </div>
                                                                        ...
                                                                        <div class="d-flex align-items-center mb-5 bg-light-success rounded p-4">
                                                                            ...
                                                                            <div class="d-flex flex-column flex-grow-1 mr-2">
                                                                                <a href="<?php echo e(route('pic.pertek-bkn.surat-usulan.pemberhentian-pejabat-fku.index')); ?>" class="font-weight-bold text-dark-75 text-hover-primary font-size-lg mb-1">Pemberhentian Pejabat Fungsional Keahlian Utama</a>
                                                                            </div>
                                                                        ...
                                                                        <div class="d-flex align-items-center mb-5 bg-light-primary rounded p-4">
                                                                            ...
                                                                            <div class="d-flex flex-column flex-grow-1 mr-2">
                                                                                <a href="<?php echo e(route('pic.pertek-bkn.surat-usulan.perpindahan-pejabat-fku.index')); ?>" class="font-weight-bold text-dark-75 text-hover-primary font-size-lg mb-1">Perpindahan Pejabat Fungsional Keahlian Utama</a>
                                                                            </div>
                                                                        ...
                                                                        <div class="d-flex align-items-center mb-5 bg-light-info rounded p-4">
                                                                            ...
                                                                            <div class="d-flex flex-column flex-grow-1 mr-2">
                                                                                <a href="<?php echo e(route('pic.pertek-bkn.surat-usulan.ralat-keppres-fku.index')); ?>" class="font-weight-bold text-dark-75 text-hover-primary font-size-lg mb-1">Ralat Keppres Jabatan Fungsional Keahlian Utama</a>
                                                                            </div>
                                                                        ...
                                                                        <div class="d-flex align-items-center mb-5 bg-light-danger rounded p-4">
                                                                            ...
                                                                            <div class="d-flex flex-column flex-grow-1 mr-2">
                                                                                <a href="<?php echo e(route('pic.pertek-bkn.surat-usulan.pembatalan-keppres-jabatan-fku.index')); ?>" class="font-weight-bold text-dark-75 text-hover-primary font-size-lg mb-1">Pembatalan Keppres Jabatan Fungsional Keahlian Utama</a>
                                                                            </div>
                                                                    ...
                                                                    <div class="pb-5" data-wizard-type="step-content">
                                                                        ...
                                                                        <div class="d-flex align-items-center mb-5 bg-light-warning rounded p-4">
                                                                            ...
                                                                            <div class="d-flex flex-column flex-grow-1 mr-2">
                                                                                <a href="<?php echo e(route('pic.pertek-bkn.surat-usulan.pengangkatan-pejabat-ns.index')); ?>" class="font-weight-bold text-dark-75 text-hover-primary font-size-lg mb-1">Pengangkatan Pejabat Non Struktural</a>
                                                                            </div>
                                                                        ...
                                                                        <div class="d-flex align-items-center mb-5 bg-light-success rounded p-4">
                                                                            ...
                                                                            <div class="d-flex flex-column flex-grow-1 mr-2">
                                                                                <a href="<?php echo e(route('pic.pertek-bkn.surat-usulan.pemberhentian-pejabat-ns.index')); ?>" class="font-weight-bold text-dark-75 text-hover-primary font-size-lg mb-1">Pemberhentian Pejabat Non Struktural</a>
                                                                            </div>
                                                                        ...
                                                                        <div class="d-flex align-items-center mb-5 bg-light-primary rounded p-4">
                                                                            ...
                                                                            <div class="d-flex flex-column flex-grow-1 mr-2">
                                                                                <a href="<?php echo e(route('pic.pertek-bkn.surat-usulan.ralat-keppres-jabatan-ns.index')); ?>" class="font-weight-bold text-dark-75 text-hover-primary font-size-lg mb-1">Ralat Keppres Jabatan Non Struktural</a>
                                                                            </div>
                                                                        ...
                                                                        <div class="d-flex align-items-center mb-5 bg-light-info rounded p-4">
                                                                            ...
                                                                            <div class="d-flex flex-column flex-grow-1 mr-2">
                                                                                <a href="<?php echo e(route('pic.pertek-bkn.surat-usulan.pembatalan-keppres-jabatan-ns.index')); ?>" class="font-weight-bold text-dark-75 text-hover-primary font-size-lg mb-1">Pembatalan Keppres Jabatan Non Struktural</a>
                                                                            </div>
                                                                    ...
                                                                    <div class="pb-5" data-wizard-type="step-content">
                                                                        ...
                                                                        <div class="d-flex align-items-center mb-5 bg-light-warning rounded p-4">
                                                                            ...
                                                                            <div class="d-flex flex-column flex-grow-1 mr-2">
                                                                                <a href="<?php echo e(route('pic.pertek-bkn.surat-usulan.pengangkatan-pejabat-lainnya.index')); ?>" class="font-weight-bold text-dark-75 text-hover-primary font-size-lg mb-1">Pengangkatan Pejabat Lainnya</a>
                                                                            </div>
                                                                        ...
                                                                        <div class="d-flex align-items-center mb-5 bg-light-primary rounded p-4">
                                                                            ...
                                                                            <div class="d-flex flex-column flex-grow-1 mr-2">
                                                                                <a href="<?php echo e(route('pic.pertek-bkn.surat-usulan.pemberhentian-pejabat-lainnya.index')); ?>" class="font-weight-bold text-dark-75 text-hover-primary font-size-lg mb-1">Pemberhentian Pejabat Lainnya</a>
                                                                            </div>
                                                                        ...
                                                                        <div class="d-flex align-items-center mb-5 bg-light-info rounded p-4">
                                                                            ...
                                                                            <div class="d-flex flex-column flex-grow-1 mr-2">
                                                                                <a href="<?php echo e(route('pic.pertek-bkn.surat-usulan.ralat-keppres-jabatan-lainnya.index')); ?>" class="font-weight-bold text-dark-75 text-hover-primary font-size-lg mb-1">Ralat Keppres Jabatan Lainnya</a>
                                                                            </div>
                                                                        ...
                                                                        <div class="d-flex align-items-center mb-5 bg-light-danger rounded p-4">
                                                                            ...
                                                                            <div class="d-flex flex-column flex-grow-1 mr-2">
                                                                                <a href="<?php echo e(route('pic.pertek-bkn.surat-usulan.pembatalan-keppres-jabatan-lainnya.index')); ?>" class="font-weight-bold text-dark-75 text-hover-primary font-size-lg mb-1">Pembatalan Keppres Jabatan Lainnya</a>
                                                                        ...
                                                                        <div class="d-flex align-items-center mb-5 bg-light-success rounded p-4">
                                                                            ...
                                                                            <div class="d-flex flex-column flex-grow-1 mr-2">
                                                                                <a href="<?php echo e(route('pic.pertek-bkn.surat-usulan.persetujuan-pengangkatan-staf-khusus.index')); ?>" class="font-weight-bold text-dark-75 text-hover-primary font-size-lg mb-1">Persetujuan pengangkatan Staf Khusus Menteri/Kepala Lembaga</a>
                                                                    ...
                                                                    <div class="d-flex justify-content-between border-top mt-5 pt-10">
                                                                        <div class="mr-2">
                                                                            <a  class="btn btn-light-primary font-weight-bold mr-2" data-wizard-type="action-prev">
                                                                                <span class="svg-icon svg-icon-2x svg-icon-hover"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                                                        <polygon points="0 0 24 0 24 24 0 24"/>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project\siapp\resources\views/pages/pic/pertek_bkn/surat_usulan/jabatan_fungsional.blade.php ENDPATH**/ ?>