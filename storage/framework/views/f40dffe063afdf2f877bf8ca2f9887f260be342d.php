                                                                    ...
                                                                    <div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
                                                                        ...
                                                                        <div class="d-flex align-items-center mb-5 bg-light-warning rounded p-4">
                                                                            ...
                                                                            <div class="d-flex flex-column flex-grow-1 mr-2">
                                                                                <a href="<?php echo e(route('pic.pertek-bkn.pemberhentian.bup-non-kpp.index')); ?>" class="font-weight-bold text-dark-75 text-hover-primary font-size-lg mb-1">BUP Non KPP</a>
                                                                            </div>
                                                                        </div>
                                                                        <div class="d-flex align-items-center mb-5 bg-light-success rounded p-4">
                                                                            ...
                                                                            <div class="d-flex flex-column flex-grow-1 mr-2">
                                                                                <a href="<?php echo e(route('pic.pertek-bkn.pemberhentian.bup-kpp.index')); ?>" class="font-weight-bold text-dark-75 text-hover-primary font-size-lg mb-1">BUP KPP</a>
                                                                            </div>
                                                                        </div>
                                                                        <div class="d-flex align-items-center mb-5 bg-light-primary rounded p-4">
                                                                            ...
                                                                            <div class="d-flex flex-column flex-grow-1 mr-2">
                                                                                <a href="<?php echo e(route('pic.pertek-bkn.pemberhentian.berhenti-atas-permintaan-sendiri.index')); ?>" class="font-weight-bold text-dark-75 text-hover-primary font-size-lg mb-1">Berhenti Atas Permintaan Sendiri</a>
                                                                            </div>
                                                                        </div>
                                                                        <div class="d-flex align-items-center mb-5 bg-light-info rounded p-4">
                                                                            ...
                                                                            <div class="d-flex flex-column flex-grow-1 mr-2">
                                                                                <a href="<?php echo e(route('pic.pertek-bkn.pemberhentian.non-bup-jda-non-kpp.index')); ?>" class="font-weight-bold text-dark-75 text-hover-primary font-size-lg mb-1">Non BUP Janda/Duda/Anak non KPP</a>
                                                                            </div>
                                                                        </div>
                                                                        <div class="d-flex align-items-center mb-5 bg-light-danger rounded p-4">
                                                                            ...
                                                                            <div class="d-flex flex-column flex-grow-1 mr-2">
                                                                                <a href="<?php echo e(route('pic.pertek-bkn.pemberhentian.non-bup-jda-kpp.index')); ?>" class="font-weight-bold text-dark-75 text-hover-primary font-size-lg mb-1">Non BUP Janda/Duda/Anak KPP</a>
                                                                            </div>
                                                                        </div>
                                                                        <div class="d-flex align-items-center mb-5 bg-light-warning rounded p-4">
                                                                            <span class="svg-icon svg-icon-warning mr-5">
                                                                            ...
                                                                            <div class="d-flex flex-column flex-grow-1 mr-2">
                                                                                <a href="<?php echo e(route('pic.pertek-bkn.pemberhentian.berhenti-tidak-dengan-hormat.index')); ?>" class="font-weight-bold text-dark-75 text-hover-primary font-size-lg mb-1">Berhenti Tidak Dengan Hormat</a>
                                                                            </div>
                                                                        </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="d-flex align-items-center mb-5 bg-light-warning rounded p-4">
                                                                            ...
                                                                            <div class="d-flex flex-column flex-grow-1 mr-2">
                                                                                <a href="<?php echo e(route('pic.pertek-bkn.pemberhentian.anumerta.index')); ?>" class="font-weight-bold text-dark-75 text-hover-primary font-size-lg mb-1">Anumerta</a>
                                                                            </div>
                                                                        </div>
                                                                        <div class="d-flex align-items-center mb-5 bg-light-success rounded p-4">
                                                                            <span class="svg-icon svg-icon-success mr-5">
                                                                            ...
                                                                            <div class="d-flex flex-column flex-grow-1 mr-2">
                                                                                <a href="<?php echo e(route('pic.pertek-bkn.pemberhentian.pemberhentian-sementara.index')); ?>" class="font-weight-bold text-dark-75 text-hover-primary font-size-lg mb-1">Pemberhentian Sementara</a>
                                                                            </div>
                                                                        </div>
                                                                        <div class="d-flex align-items-center mb-5 bg-light-primary rounded p-4">
                                                                            <span class="svg-icon svg-icon-primary mr-5">
                                                                            ...
                                                                            <div class="d-flex flex-column flex-grow-1 mr-2">
                                                                                <a href="<?php echo e(route('pic.pertek-bkn.pemberhentian.ralat-keppres-pemberhentian.index')); ?>" class="font-weight-bold text-dark-75 text-hover-primary font-size-lg mb-1">Ralat Keppres Pemberhentian</a>
                                                                            </div>
                                                                        </div>
                                                                        <div class="d-flex align-items-center mb-5 bg-light-info rounded p-4">
                                                                            <span class="svg-icon svg-icon-info mr-5">
                                                                            ...
                                                                            <div class="d-flex flex-column flex-grow-1 mr-2">
                                                                                <a href="<?php echo e(route('pic.pertek-bkn.pemberhentian.pembatalan-keppres-pemberhentian.index')); ?>" class="font-weight-bold text-dark-75 text-hover-primary font-size-lg mb-1">Pembatalan Keppres Pemberhentian</a>
                                                                            </div>
                                                                        </div>
                                                                        <div class="d-flex align-items-center mb-5 bg-light-danger rounded p-4">
                                                                            <span class="svg-icon svg-icon-danger mr-5">
                                                                            ...
                                                                            <div class="d-flex flex-column flex-grow-1 mr-2">
                                                                                <a href="<?php echo e(route('pic.pertek-bkn.pemberhentian.petikan-keppres-yang-hilang.index')); ?>" class="font-weight-bold text-dark-75 text-hover-primary font-size-lg mb-1">Petikan Keppres yang Hilang/Rusak</a>
                                                                            </div>
                                                                        </div>
                                                                        <div class="d-flex align-items-center mb-5 rounded p-4">
                                                                            ...
                                                                            <div class="d-flex flex-column flex-grow-1 mr-2">
                                                                                <a href="<?php echo e(route('pic.pertek-bkn.kenaikan-pangkat.index')); ?>" class="font-weight-bold text-dark-75 text-hover-primary font-size-lg mb-1"></a>
                                                                            </div>
                                                                        </div>
                                                                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project\siapp\resources\views/pages/pic/pertek_bkn/pemberhentian/pemberhentian.blade.php ENDPATH**/ ?>