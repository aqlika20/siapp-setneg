                                                ...
                                                <tbody>
                                                    ...
                                                    <?php $__currentLoopData = $kenaikans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kenaikan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="<?php echo e(route('jf-ahli-pertama-kp.inbox.kenaikan_pangkat.verif', ['id' => $kenaikan->id])); ?>" type="button" class="btn btn-success font-weight-bold align-items-md-end">Verifikasi</a>
                                                            </td>
                                                        </tr>
                                            ...
                                            <tbody>
                                                <?php $__currentLoopData = $kenaikan_pendings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kenaikan_pending): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="<?php echo e(route('jf-ahli-pertama-kp.inbox.kenaikan_pangkat.verif', ['id' => $kenaikan_pending->id])); ?>" type="button" class="btn btn-success font-weight-bold align-items-md-end">Verifikasi</a>
                                                            </td>
                                                        </tr>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </tbody>
                                    ...
                                    <div class="tab-pane fade " id="tab_tolak" role="tabpanel" aria-labelledby="tab_tolak">
                                        ...
                                        <table class="datatable cell-border" id="tb_tolak">
                                            ...
                                            <tbody>
                                                ...
                                                <?php $__currentLoopData = $kenaikan_tolaks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kenaikan_tolak): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr>
                                                            <td><?php echo e($kenaikan_tolak->tanggal_surat_usulan); ?></td>
                                                            <td><?php echo e($kenaikan_tolak->no_surat_usulan); ?></td>
                                                            <td><?php echo e($kenaikan_tolak->instansi_pengusul); ?></td>
                                                            <td><div style="color: #FFA800;"><?php echo e(Helper::defineJenisLayananBy($kenaikan_tolak->jenis_layanan)); ?></div></td>
                                                            <td><div style="color: #3699FF;"><?php echo e($kenaikan_tolak->nip); ?></div></td>
                                                            <td><?php echo e($kenaikan_tolak->nama); ?></td>
                                                            <td>
                                                                <a href="<?php echo e(route('jf-ahli-pertama-kp.inbox.kenaikan_pangkat.verif', ['id' => $kenaikan_tolak->id])); ?>" type="button" class="btn btn-success font-weight-bold align-items-md-end">Verifikasi</a>
                                                            </td>
                                                        </tr>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project\siapp\resources\views/pages/jf_ahli_pertama_kp/inbox/usulan.blade.php ENDPATH**/ ?>