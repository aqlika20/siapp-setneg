...
<div class="card card-custom">
    ...
    <div class="card-body">
        <form method="POST" id="form" action="<?php echo e(route('warehouse.incoming-material.dextrin.create')); ?>">
                <?php echo csrf_field(); ?>
                                ...
                                <div class="form-group row item">
                                    <div class="form-group col-md-4">
                                        ...
                                        <div class="col-md-12 p-0">
                                            <input type="text" id="item" class="form-control item_view <?php $__errorArgs = ['item'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="item" autocomplete="item" value="<?php echo e($item->item_id); ?> | <?php echo e($item->item_desc); ?>" autofocus readonly required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-md-2">
                                        ...
                                        <div class="col-md-12 p-0">
                                            <input type="number" pattern="[0-9]+([\.,][0-9]+)?" min="0.001" step="0.001" class="form-control qty <?php $__errorArgs = ['qty'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="uom" autocomplete="uom" value="KG" autofocus readonly required>
                                        </div>
                                    </div>
...
unset($__errorArgs, $__bag); ?>" name="batch_no" autocomplete="batch_no" autofocus required>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <button type="button" class="add_more_item_detail btn btn-primary"><?php echo e(__('Add More Item Detail')); ?></button>
                                    </div>
                                    <div class="col-md-2">
                                    </div>
                                    <div class="col">
...
unset($__errorArgs, $__bag); ?>" name="sscc_no_detail[]" autocomplete="sscc_no_detail" autofocus>
        ...
        <div class="form-group col-md-2">
            ...
            <div>
                <input type="number" pattern="[0-9]+([\.,][0-9]+)?" min="0.001" step="0.001" class="qty_detail form-control <?php $__errorArgs = ['qty_detail'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/pt_tigaraksa_satria/resources/views/pages/warehouse/incoming_material/dextrin.blade.php ENDPATH**/ ?>