                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-md-9 col-sm-12">
                                                    <select class="form-control select22" style="width: 230px;" id="alasan_pembatalan" name="alasan_pembatalan">
                                                        ...
                                                        <option value="1" <?php echo e(old('alasan_pembatalan') == 1 ? 'selected' : ''); ?>>Meninggal Dunia Sebelum Periode Kenaikan Pangkat</option>
                                                        <option value="2" <?php echo e(old('alasan_pembatalan') == 1 ? 'selected' : ''); ?>>Alasan Terkait Dengan Jabatan</option>
                                                        <option value="0" <?php echo e(old('alasan_pembatalan') == 1 ? 'selected' : ''); ?>>Lainnya</option>
                                                    </select>
                                                </div>
                                            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/siapp/resources/views/pages/pic/administrasi/kenaikan_pangkat/form/pembatalan_keppres_kenaikan_pangkat.blade.php ENDPATH**/ ?>