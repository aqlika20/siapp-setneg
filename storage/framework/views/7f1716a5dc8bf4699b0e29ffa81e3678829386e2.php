                                                    ...
                                                    <div class="card-body pl-12">
                                                        <div class="table-responsive">
                                                            <th style="width: 200px;">
                                                                <form method="POST" action="<?php echo e(route('koor-pokja-pensiun.inbox.distributor.store_group', ['id' => $pemberhentian->id, 'jenis_layanan' => $pemberhentian->jenis_layanan])); ?>">
                                                                    <?php echo csrf_field(); ?> 
                                                                        ...
                                                                        <?php $__currentLoopData = $group_users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                            <?php if($list->name == $user->group && $role == $user->role): ?>
                                                                                <tr>
                                                                                    ...
                                                                                    <td> 
                                                                                        <form method="POST" action="<?php echo e(route('koor-pokja-pensiun.inbox.distributor.store_distributor', ['id' => $pemberhentian->id,  'jenis_layanan' => $pemberhentian->jenis_layanan])); ?>">
                                                                                            <?php echo csrf_field(); ?> 
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project\siapp\resources\views/pages/koor_pokja_pensiun/inbox/distributor_pemberhentian.blade.php ENDPATH**/ ?>