                                                        ...
                                                        <table>
                                                            ...
                                                            <?php $__currentLoopData = $file_data_usulans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <tr>
                                                                    ...
                                                                    <!-- <iframe src="<?php echo e(url('/storage/app/pengangkatan_pejabat_fungsional_keahlian_utama_attachments/data_usulan/'. $file)); ?>"></iframe> -->
                                                                    <!-- <iframe src="<?php echo e(Storage::url('/storage/app/pengangkatan_pejabat_fungsional_keahlian_utama_attachments/data_usulan/'. $file)); ?>"></iframe> -->
                                                                    <!-- <iframe src="<?php echo e(url('/storage/app/JFKU_Attachments/data_asn/'. $file)); ?>"></iframe> -->
                                                                    <iframe src="<?php echo e(URL::Storage('/storage/app/pengangkatan_pejabat_fungsional_keahlian_utama_attachments/data_usulan/'.$file, 'Open the pdf!')); ?>"></iframe>
                                                                    <td><a id="detail" type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#modal-view" data-file="<?php echo e($file); ?>">Lihat</a></td>
                                                                </tr>
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body table-responsive">
                                                                <p>
                                                                    <iframe src="<?php echo e(url('/storege/app/JFKU_Attachments/data_asn/'. $file)); ?>"></iframe>
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ardim\Desktop\siapp\resources\views/pages/koor_pokja/inbox/verif.blade.php ENDPATH**/ ?>