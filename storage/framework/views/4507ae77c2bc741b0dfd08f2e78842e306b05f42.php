								...
								<div class="card card-custom">
									<div class="card-header flex-wrap border-0 pt-6 pb-0">
										<div class="card-title">
											...
											<span class="d-block text-muted pt-2 font-size-sm">List riwayat dokumen</span></h3>
										</div>
                                        <div class="card-toolbar">
                                            <ul class="nav nav-pills nav-pills-sm nav-dark-75">
                                                <li class="nav-item">
                                                    <a class="nav-link py-2 px-4 active" data-toggle="tab" href="#kt_tab_pane_11_1">Disetujui</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link py-2 px-4" data-toggle="tab" href="#kt_tab_pane_11_2">Tidak Disetujui</a>
                                                </li>
                                            </ul>
                                        </div>
									</div>
                                                        ...
                                                        <table class="datatable datatable-bordered datatable-head-custom" id="kt_datatable">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <div >
                                                                            <span class="label label-lg label-light-success label-inline">Disetujui</span>
                                                                        </div>														
                                                                    </td>
                                                                    <td>
                                                        ...
                                                        <table class="table data-table-bordered datatable-head-custom" id="kt_datatable"> 
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <div >
                                                                            <span class="label label-lg label-light-danger label-inline">Tidak Disetujui</span>
                                                                        </div>														
                                                                    </td>
                                                                    <td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ardim\Desktop\siapp jadi\siapp\resources\views/pages/demo3/riwayat.blade.php ENDPATH**/ ?>