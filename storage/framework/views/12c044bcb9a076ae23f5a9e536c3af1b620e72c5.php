                        ...
                        <div class="wizard wizard-3" id="kt_wizard_v3" data-wizard-state="step-first" data-wizard-clickable="true">
                            ...
                            <div class="row justify-content-center py-10 px-8 py-lg-12 px-lg-10">
                                <div class="col-xl-20 col-xxl-12">
                                    <!--begin: Wizard Form-->
                                    <form class="form" id="kt_form" action="<?php echo e(route('pic.administrasi.pemberhentian.anumerta.store')); ?>" enctype="multipart/form-data" method="POST">
                                        <?php echo csrf_field(); ?>
                                        ...
                                        <div class="pb-6" style="margin-left: 50px; margin-right: 50px;" data-wizard-type="step-content" data-wizard-state="current">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-lg-3 col-form-label">Upload Akte kematian <a style="color: #FF0000;">*</a></label>
                                                <div class="col-lg-9">
                                                    <input id="file_akte_kematian" name="file_akte_kematian[]" accept=".jpg,.jpeg,.png,.pdf" type="file" class="file" data-show-preview="false" multiple/>
                                            ...
                                            <div class="form-group row">
                                                <label class="col-lg-3 col-form-label">Upload Data Pendukung terkait Anumerta <a style="color: #FF0000;">*</a></label>
                                                <div class="col-lg-9">
                                                    <input id="file_data_pendukung_terkait" name="file_data_pendukung_terkait[]" accept=".jpg,.jpeg,.png,.pdf" type="file" class="file" data-show-preview="false" multiple/>
                                        ...
                                        <div class="pb-6" style="margin-left: 50px; margin-right: 50px;" data-wizard-type="step-content">
                                            ...
                                            <!--begin::Input-->
                                            <div class="form-group row">
                                                <label class="col-form-label col-lg-3 col-sm-12">Nama PNS <a style="color: #FF0000;">*</a></label>
                                                <div class="col-lg-9 col-md-9 col-sm-12">
                                                    <div class="input-group date">
                                            ...
                                            <!--begin::Input-->
                                            <div class="form-group row">
                                                <label class="col-form-label col-lg-3 col-sm-12">Nama Janda / Duda / Anak <a style="color: #FF0000;">*</a></label>
                                                <div class="col-lg-9 col-md-9 col-sm-12">
                                                    <div class="input-group date">
                                                        <input type="text" class="form-control" id="nama_janda_duda_anak" name="nama_janda_duda_anak" value="<?php echo e(old('nama_janda_duda_anak')); ?>" autocomplete="off" />
                                                    </div>
                                                </div>
                                            </div>
                                            <!--end::Input-->
                                            ...
                                            <div class="form-group row">
                                                <label class="col-form-label col-lg-3 col-sm-12">Pangkat (Gol/Ruang) lama <a style="color: #FF0000;">*</a></label>
                                                <div class="col-lg-9 col-md-9 col-sm-12">
                                                    <select class="form-control select2" style="width: 230px;" id="pangkat_lama" name="pangkat_lama">
                                                        ...
                                                        <?php $__currentLoopData = $pangkats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pangkat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($pangkat->name); ?>" <?php if(old("pangkat_lama") == $pangkat->name): ?> selected="selected" <?php endif; ?>><?php echo e($pangkat->name); ?> (<?php echo e($pangkat->golongan); ?>/<?php echo e($pangkat->ruang); ?></option>
                                            ...
                                            <div class="form-group row">
                                                <label class="col-form-label col-lg-3 col-sm-12">TMT Pangkat Baru <a style="color: #FF0000;">*</a></label>
                                                <div class="col-lg-5 col-md-9 col-sm-12">
                                                    <div class="input-group date">
                                                        <input type="text" class="form-control datetimepicker-input my-datepicker" id="tmt_pangkat_baru" name="tmt_pangkat_baru" data-toggle="datetimepicker" data-target="#tmt_pangkat_baru" placeholder="Pilih Tanggal" value="<?php echo e(old('tmt_pangkat_baru')); ?>" autocomplete="off" />
                                                        <div class="input-group-append">
                                                            <span class="input-group-text">
                                                                <i class="la la-calendar"></i>
                                                            </span>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-5 col-md-9 col-sm-12">
                                                    <div class="input-group date">
                                                        <input type="text" class="form-control datetimepicker-input my-datepicker" id="tmt_pensiun" name="tmt_pensiun" data-toggle="datetimepicker" data-target="#tmt_pensiun" placeholder="Pilih Tanggal" value="<?php echo e(old('tmt_pensiun')); ?>" autocomplete="off" />
                                                        <div class="input-group-append">
                                                            <span class="input-group-text">
                                                                <i class="la la-calendar"></i>
                                                            </span>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-md-9 col-sm-12">
                                                    <div class="input-group date">
                                                        <textarea type="text" class="form-control" id="alamat_setelah_pensiun" name="alamat_setelah_pensiun" value="<?php echo e(old('alamat_setelah_pensiun')); ?>" autocomplete="off" require></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9">
                                                    <input id="file_berita_acara_pelantikan" name="file_berita_acara_pelantikan[]" accept=".jpg,.jpeg,.png,.pdf" type="file" class="file" data-show-preview="false" multiple/>
                                        ...
                                        <div class="pb-6" style="margin-left: 50px; margin-right: 50px;" data-wizard-type="step-content">
                                            <div id="kt_repeater_1">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-lg-3 col-form-label">Upload Pas Foto Berwarna Janda / Duda / Anak <a style="color: #FF0000;">*</a></label>
                                                    <div class="col-lg-9">
                                                        <input id="file_pas_foto" name="file_pas_foto[]" accept=".jpg,.jpeg,.png,.pdf" type="file" class="file" data-show-preview="false" multiple/>
                                                        <!-- <div class="dropzone dropzone-multi" id="kt_dropzone_8">
                                                            <div class="dropzone-panel mb-lg-0 mb-2">
                                                                <a class="dropzone-select btn btn-light-primary font-weight-bold btn-sm">Attach files</a>
                                                                <a class="dropzone-upload btn btn-light-primary font-weight-bold btn-sm">Upload All</a>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9">
                                                        <input id="file_sk_tidak_pernah_dijatuhi_hukuman" name="file_sk_tidak_pernah_dijatuhi_hukuman[]" accept=".jpg,.jpeg,.png,.pdf" type="file" class="file" data-show-preview="false" multiple/>
                                                        <!-- <div class="dropzone dropzone-multi" id="kt_dropzone_8">
                                                            <div class="dropzone-panel mb-lg-0 mb-2">
                                                                <a class="dropzone-select btn btn-light-primary font-weight-bold btn-sm">Attach files</a>
                                                                <a class="dropzone-upload btn btn-light-primary font-weight-bold btn-sm">Upload All</a>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9">
                                                        <input id="file_sk_tidak_sedang_dalam_hukum_dpcp" name="file_sk_tidak_sedang_dalam_hukum_dpcp[]" accept=".jpg,.jpeg,.png,.pdf" type="file" class="file" data-show-preview="false" multiple/>
                                                        <!-- <div class="dropzone dropzone-multi" id="kt_dropzone_8">
                                                            <div class="dropzone-panel mb-lg-0 mb-2">
                                                                <a class="dropzone-select btn btn-light-primary font-weight-bold btn-sm">Attach files</a>
                                                                <a class="dropzone-upload btn btn-light-primary font-weight-bold btn-sm">Upload All</a>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9 col-md-9 col-sm-12">
                                                        ...
                                                        <div style="margin-bottom:10px;">
                                                            <label class="checkbox checkbox-outline checkbox-outline-2x checkbox-primary">
                                                                <input type="checkbox" id="checked_file_akte_kematian" disabled/>
                                                                <span></span><div style="margin-left: 10px;">File Akte kematian</div>
                                                            </label>
                                                        </div>
                                                        <div style="margin-bottom:10px;">
                                                            <label class="checkbox checkbox-outline checkbox-outline-2x checkbox-primary">
                                                                <input type="checkbox" id="checked_file_data_pendukung_terkait" disabled/>
                                                                <span></span><div style="margin-left: 10px;">File Data Pendukung terkait Anumerta</div>
                                                            </label>
                                                        </div>
                                                        <div style="margin-bottom:10px;">
                                                            <label class="checkbox checkbox-outline checkbox-outline-2x checkbox-primary">
                                                        ...
                                                        <div style="margin-bottom:10px;">
                                                            <label class="checkbox checkbox-outline checkbox-outline-2x checkbox-primary">
                                                                ...
                                                                <span></span><div style="margin-left: 10px;">File Pas Foto Berwarna Janda / Duda / Anak</div>
                                                            </label>
                                                        </div>
                                                        <div style="margin-bottom:10px;">
                                                            <label class="checkbox checkbox-outline checkbox-outline-2x checkbox-primary">
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#file_akte_kematian").on("change", function () {
                if ($('#file_akte_kematian')[0].files.length != 0) {
                    $("#checked_file_akte_kematian").attr('checked', true);
                } else {
                    $("#checked_file_akte_kematian").attr('checked',false);
                }
            });

            $("#file_data_pendukung_terkait").on("change", function () {
                if ($('#file_data_pendukung_terkait')[0].files.length != 0) {
                    $("#checked_file_data_pendukung_terkait").attr('checked', true);
                } else {
                    $("#checked_file_data_pendukung_terkait").attr('checked',false);
                }
            });
    ...
    $("#file_akte_kematian").on("change", function() {
    if ($("#file_akte_kematian")[0].files.length > 5) {
        alert('Hanya boleh upload 5 file!.');
        $('#file_akte_kematian').val('');
    }
    });
    ...
    $("#file_data_pendukung_terkait").on("change", function() {
    if ($("#file_data_pendukung_terkait")[0].files.length > 5) {
        alert('Hanya boleh upload 5 file!.');
        $('#file_data_pendukung_terkait').val('');
    }
    });
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project\siapp\resources\views/pages/pic/administrasi/pemberhentian/form/anumerta.blade.php ENDPATH**/ ?>