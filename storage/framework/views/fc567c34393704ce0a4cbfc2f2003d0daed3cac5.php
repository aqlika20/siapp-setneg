                        ...
                        <div class="wizard wizard-3" id="kt_wizard_v3" data-wizard-state="step-first" data-wizard-clickable="true">
                            ...
                            <div class="row justify-content-center py-10 px-8 py-lg-12 px-lg-10">
                                <div class="col-xl-20 col-xxl-12">
                                    <!--begin: Wizard Form-->
                                    <form class="form" id="kt_form" action="<?php echo e(route('pic.administrasi.pemberhentian.ralat-keppres-pemberhentian.store')); ?>" enctype="multipart/form-data" method="POST">
                                        <?php echo csrf_field(); ?>
                                        ...
                                        <div class="pb-6" style="margin-left: 50px; margin-right: 50px;" data-wizard-type="step-content" data-wizard-state="current">
                                            ...
                                            <!--end::Input-->
                                            <div class="form-group row">
                                                <label class="col-lg-3 col-form-label">Upload Data Dokumen Klarifikasi</label>
                                                <div class="col-lg-9">
                                                    <input id="file_data_dokumen_klarifikasi" name="file_data_dokumen_klarifikasi[]" type="file" class="file" data-show-preview="false" multiple/>
                                            ...
                                            <!--end::Input-->
                                            <div class="form-group row">
                                                <label class="col-lg-3 col-form-label">Petikan Asli SK Pensiun yang salah</label>
                                                <div class="col-lg-9">
                                                    <input id="file_petikan_asli_sk_pensiun" name="file_petikan_asli_sk_pensiun[]" type="file" class="file" data-show-preview="false" multiple/>
                                        ...
                                        <div class="pb-6" style="margin-left: 50px; margin-right: 50px;" data-wizard-type="step-content">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-md-9 col-sm-12">
                                                    <div class="input-group">
                                                        <input type="number" class="form-control" id="no_urut" name="no_urut" value="<?php echo e(old('no_urut')); ?>" autocomplete="off" require/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-md-9 col-sm-12">
                                                    <div class="input-group">
                                                        <textarea type="text" class="form-control" id="data_salah" name="data_salah" value="<?php echo e(old('data_salah')); ?>" autocomplete="off" require></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-md-9 col-sm-12">
                                                    <div class="input-group">
                                                        <textarea type="text" class="form-control" id="seharusnya" name="seharusnya" value="<?php echo e(old('seharusnya')); ?>" autocomplete="off" require></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project\siapp\resources\views/pages/pic/administrasi/pemberhentian/form/ralat_keppres_pemberhentian.blade.php ENDPATH**/ ?>