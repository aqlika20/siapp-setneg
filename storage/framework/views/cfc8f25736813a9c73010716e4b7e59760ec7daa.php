                ...
                <div class="container">
                    ...
                    <div class="card-header flex-wrap border-0 pt-6 pb-0" style="background-color: #FFA800;">
                        <div class="card-title">
                            <h3 class="card-label">Update <?php echo e(Helper::defineJenisLayananBy($verifikasi->jenis_layanan)); ?>
                                ...
                                <div class="row justify-content-center py-10 px-8 py-lg-12 px-lg-10">
                                    <div class="col-xl-20 col-xxl-12">
                                        <!--begin: Wizard Form-->
                                            ...
                                            <?php if($verifikasi->jenis_layanan == '16' || $verifikasi->jenis_layanan == '18'): ?>
                                            <div class="pb-6" style="margin-left: 50px; margin-right: 50px;">
                                            ...
                                            <div class="d-flex justify-content-between mt-5 pt-10" style="margin-left: 50px; margin-right: 50px;">
                                                <div class="mr-2">
                                                    <a href="<?php echo e(route('pic.inbox.index')); ?>" type="button" class="btn btn-light-primary font-weight-bolder text-uppercase px-9 py-4">Kembali</a>
                                                </div>
                                                <div>
                                                    <table>
                                                        <th style="margin-right: 10px;">
                                                            <form method="POST" action="<?php echo e(route('pic.inbox.kenaikan_pangkat.store_proses')); ?>">
                                                                <?php echo csrf_field(); ?> 
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project\siapp\resources\views/pages/pic/verif_kenaikan_pangkat.blade.php ENDPATH**/ ?>