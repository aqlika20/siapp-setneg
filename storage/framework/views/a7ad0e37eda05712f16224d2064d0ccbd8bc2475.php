...
<?php $__env->startSection('content'); ?>
                                ...
                                <div class="card card-custom">
                                    ...
                                    <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4 my-2 my-md-0">
                                                            <div class="input-icon">
                                                                <input type="text" class="form-control" placeholder="Search Item ID" id="super_admin_setting_item_definition_search_query" />
                                                                <span>
                                        ...
                                        <!--end: Search Form-->
                                        <!--begin: Datatable-->
                                        <table class="datatable datatable-borderless" id="super_admin_setting_item_definition">
                                            <thead>
                                                <tr>
                                                    <th>#</th>
                                                    <th>Item ID</th>
                                            ...
                                            <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td><?php if($item->notes == '' ): ?> - <?php endif; ?>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-md-12 text-center">
                                                            <a href="/template/import_csv_item_definition.csv" id="template_csv">Download Template CSV</a>
                                                            <p>Note : <br>
                                                                - Fill with notepad or similar app (don't use excel or spreadsheet) <br>
                                                                - Fill 1 if the item is packaging for is_packaging field, fill 0 if the item is not packaging <br>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            ...
                                            <form method="POST" action="<?php echo e(route('super-admin.setting.item-definition.create.manual')); ?>">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="item_id" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Item ID')); ?></label>
...
unset($__errorArgs, $__bag); ?>" name="item_id" required autocomplete="item_id" autofocus>
                                                        </div>
                                                    </div>

                                                    <div class="form-group row">
                                                        <label for="item_desc" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Item Desc')); ?></label>
...
unset($__errorArgs, $__bag); ?>" name="item_desc" required autocomplete="item_desc" autofocus>
                                                        </div>
                                                    </div>

                                                    <div class="form-group row">
                                                        <label for="is_packaging" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Is Packaging?')); ?></label>

                                                        <div class="col-md-1">
                                                            <input id="is_packaging" type='checkbox' class="is_packaging form-control" name='is_packaging' class='form-control' value='1'>
                                                        </div>
                                                    </div>

                                                    <div class="form-group row">
                                                        <label for="using_meter" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Using Meter?')); ?></label>

                                                        <div class="col-md-1">
                                                            <input id="using_meter" type='checkbox' class="using_meter form-control" name='using_meter' class='form-control' value='1'>
                                                        </div>
                                                    </div>
