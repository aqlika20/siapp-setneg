                                                ...
                                                <tbody>
                                                    ...
                                                    <?php $__currentLoopData = $kenaikans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kenaikan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="<?php echo e(route('jf-ahli-kp.inbox.kenaikan_pangkat.verif', ['id' => $kenaikan->id])); ?>" type="button" class="btn btn-success font-weight-bold align-items-md-end">Verifikasi</a>
                                                            </td>
                                                        </tr>
                                            ...
                                            <tbody>
                                                <?php $__currentLoopData = $kenaikan_pendings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kenaikan_pending): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="<?php echo e(route('jf-ahli-kp.inbox.kenaikan_pangkat.verif', ['id' => $kenaikan_pending->id])); ?>" type="button" class="btn btn-success font-weight-bold align-items-md-end">Verifikasi</a>
                                                            </td>
                                                        </tr>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </tbody>
                                            ...
                                            <tbody>
                                                ...
                                                <?php $__currentLoopData = $kenaikan_tolaks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kenaikan_tolak): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="<?php echo e(route('jf-ahli-kp.inbox.kenaikan_pangkat.verif', ['id' => $kenaikan_tolak->id])); ?>" type="button" class="btn btn-success font-weight-bold align-items-md-end">Verifikasi</a>
                                                            </td>
                                                        </tr>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ardim\Desktop\siapp2\siapp\resources\views/pages/jf_ahli_kp/inbox/usulan.blade.php ENDPATH**/ ?>