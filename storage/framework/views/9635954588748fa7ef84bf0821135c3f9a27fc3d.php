    ...
    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
        ...
        <div
            ...
            <ul class="menu-nav ">
                ...
                <li class="menu-item  menu-item-submenu <?php echo e((strpos(Route::currentRouteName(), 'setting') !== false) ? 'menu-item-active' : ''); ?>" aria-haspopup="true" data-menu-toggle="hover">
                    <a href="#" class="menu-link menu-toggle">
                        ...
                        <span class="menu-text">Pertek BKN</span>
                        <i class="menu-arrow"></i>
                    </a>
                    <div class="menu-submenu ">
                        <span class="menu-arrow"></span>
                        <ul class="menu-subnav">
                            <li class="menu-item  menu-item-parent" aria-haspopup="true">
                                <span class="menu-link"><span class="menu-text">Pertek BKN</span></span>
                            </li>
                            <li class="menu-item <?php echo e((strpos($page_title, 'PIC | Pertek BKN | Jabatan Fungsional') !== false) ? 'menu-item-active' : ''); ?>" aria-haspopup="true">
                                <a href="<?php echo e(route('pic.pertek-bkn.surat-usulan.index')); ?>" class="menu-link "><i class="menu-bullet menu-bullet-line"><span></span></i><span class="menu-text">Jabatan Fungsional</span></a>
                            </li>
                            <li class="menu-item <?php echo e((strpos($page_title, 'PIC | Pertek BKN | Kenaikan Pangkat') !== false) ? 'menu-item-active' : ''); ?>" aria-haspopup="true">
                                <a href="<?php echo e(route('pic.pertek-bkn.kenaikan-pangkat.index')); ?>" class="menu-link "><i class="menu-bullet menu-bullet-line"><span></span></i><span class="menu-text">Kenaikan Pangkat</span></a>
                            </li>
                            <li class="menu-item <?php echo e((strpos($page_title, 'PIC | Pertek BKN | Pemberhentian') !== false) ? 'menu-item-active' : ''); ?>" aria-haspopup="true">
                                <a href="<?php echo e(route('pic.pertek-bkn.pemberhentian.index')); ?>" class="menu-link "><i class="menu-bullet menu-bullet-line"><span></span></i><span class="menu-text">Pemberhentian</span></a>
                            </li>
                            <!-- <li class="menu-item <?php echo e((strpos($page_title, 'PIC | Pertek BKN | Status Usulan') !== false) ? 'menu-item-active' : ''); ?>" aria-haspopup="true">
                                <a href="<?php echo e(route('pic.pertek-bkn.status-usulan.index')); ?>" class="menu-link "><i class="menu-bullet menu-bullet-line"><span></span></i><span class="menu-text">Status Usulan</span></a>
                            </li> -->
                        </ul>
                    </div>
                </li>
            ...
            <?php if($currentUser->roles_id == 2): ?> 
                ...
                <li class="menu-item <?php echo e((strpos($page_title, 'KemenSetneg | Pertek') !== false) ? 'menu-item-active' : ''); ?>" aria-haspopup="true">
                    <a href="<?php echo e(route('koor-pokja.pertek.index')); ?>" class="menu-link ">
                        <span class="svg-icon menu-icon"><!--begin::Svg Icon | path:media/svg/icons/Design/Layers.svg-->
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-mailbox" viewBox="0 0 16 16">
                                <path d="M4 4a3 3 0 0 0-3 3v6h6V7a3 3 0 0 0-3-3zm0-1h8a4 4 0 0 1 4 4v6a1 1 0 0 1-1 1H1a1 1 0 0 1-1-1V7a4 4 0 0 1 4-4zm2.646 1A3.99 3.99 0 0 1 8 7v6h7V7a3 3 0 0 0-3-3H6.646z"/>
                                <path d="M11.793 8.5H9v-1h5a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-1a.5.5 0 0 1-.354-.146l-.853-.854zM5 7c0 .552-.448 0-1 0s-1 .552-1 0a1 1 0 0 1 2 0z"/>
                        ...
                        <span class="menu-text">Pertek</span>
                    </a>
                </li>

                <li class="menu-item <?php echo e((strpos($page_title, 'KemenSetneg | RKP') !== false) ? 'menu-item-active' : ''); ?>" aria-haspopup="true">
                    <a href="<?php echo e(route('koor-pokja.rkp.index')); ?>" class="menu-link ">
                        <span class="svg-icon menu-icon"><!--begin::Svg Icon | path:media/svg/icons/Design/Layers.svg-->
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-mailbox" viewBox="0 0 16 16">
                                <path d="M4 4a3 3 0 0 0-3 3v6h6V7a3 3 0 0 0-3-3zm0-1h8a4 4 0 0 1 4 4v6a1 1 0 0 1-1 1H1a1 1 0 0 1-1-1V7a4 4 0 0 1 4-4zm2.646 1A3.99 3.99 0 0 1 8 7v6h7V7a3 3 0 0 0-3-3H6.646z"/>
                                <path d="M11.793 8.5H9v-1h5a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-1a.5.5 0 0 1-.354-.146l-.853-.854zM5 7c0 .552-.448 0-1 0s-1 .552-1 0a1 1 0 0 1 2 0z"/>
...
<?php /**PATH C:\Users\ardim\Desktop\siapp\resources\views/layout/base/_aside.blade.php ENDPATH**/ ?>