                                ...
                                <div class="card card-custom">
                                        ...
                                        <table class="datatable datatable-borderless" id="super_admin_setting_product_definition">
                                            ...
                                            <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form method="POST" action="<?php echo e(route('super-admin.setting.product-definition.delete',[$product->id])); ?>">
                                                            <?php echo csrf_field(); ?> 
                                                            <?php echo method_field('DELETE'); ?>
                                                            <a href="<?php echo e(route('super-admin.setting.product-definition.detail',[$product->id])); ?>" title="Detail" class="btn btn-icon btn-light btn-sm mx-1">
                                                                <?php echo e(Metronic::getSVG("media/svg/icons/Files/File.svg", "svg-icon-md svg-icon-primary")); ?>

                                                            </a>
                                                            <a href="<?php echo e(route('super-admin.setting.product-definition.view',[$product->id])); ?>" title="Edit" class="btn btn-icon btn-light btn-sm mx-1">
                                    ...
                                    <div class="modal fade" id="newDataInputCSV" tabindex="-1" role="dialog" aria-labelledby="newDataInputCSVLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            ...
                                            <form method="POST" action="<?php echo e(route('super-admin.setting.product-definition.create.csv')); ?>" enctype="multipart/form-data">
...
unset($__errorArgs, $__bag); ?>" name="upload_csv" required autocomplete="upload_csv" autofocus>
                                    ...
                                    <div class="modal fade" id="newDataInputManual" tabindex="-1" role="dialog" aria-labelledby="newDataInputManualLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                            <form method="POST" action="<?php echo e(route('super-admin.setting.product-definition.create.manual')); ?>">
                                                <div class="modal-header">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/pt_tigaraksa_satria/resources/views/pages/super_admin/setting/product_definition.blade.php ENDPATH**/ ?>