...
class PemberhentianController extends Controller
{
    ...
    public function index() 
    {
        ...
        $page_title = 'Super Admin | Administrasi | Pemberhentian';
        $page_description = 'Pemberhentian';
        $pengangkatans = Pengangkatan::where('status', 'Prosess')->get();
        return view('pages.super_admin.administrasi.pemberhentian.pemberhentian', compact('page_title', 'page_description', 'currentUser', 'pengangkatans'));
    }
}
