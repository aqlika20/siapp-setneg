...
class BerhentiTidakHormatController extends Controller
{
    ...
    public function index() 
    {
        ...
        $page_title = 'Super Admin | Administrasi | Pemberhentian | Berhenti Tidak Dengan Hormat';
        $page_description = 'Berhenti Tidak Dengan Hormat';
        $pangkats = Pangkat::All();
        $periodes = Periode::All();
        return view('pages.super_admin.administrasi.pemberhentian.form.berhenti_tidak_hormat', compact('page_title', 'page_description', 'currentUser', 'pangkats', 'periodes'));
    }
