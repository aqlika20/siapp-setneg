...
class AnumertaController extends Controller
{
    ...
    public function index() 
    {
        ...
        $page_title = 'Super Admin | Administrasi | Pemberhentian | Anumerta';
        $page_description = 'Anumerta';
        $pangkats = Pangkat::All();
        $periodes = Periode::All();
        return view('pages.super_admin.administrasi.pemberhentian.form.anumerta', compact('page_title', 'page_description', 'currentUser', 'pangkats', 'periodes'));
    }
