...
class BUPNonKPPController extends Controller
{
    ...
    public function index() 
    {
        ...
        $page_title = 'Super Admin | Administrasi | Pemberhentian | BUP Non KPP';
        $page_description = 'BUP Non KPP';
        $pangkats = Pangkat::All();
        $periodes = Periode::All();
        return view('pages.super_admin.administrasi.pemberhentian.form.bup_non_kpp', compact('page_title', 'page_description', 'currentUser', 'pangkats', 'periodes'));
    }
