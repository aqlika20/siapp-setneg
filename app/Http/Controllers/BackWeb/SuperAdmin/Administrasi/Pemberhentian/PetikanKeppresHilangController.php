...
class PetikanKeppresHilangController extends Controller
{
    ...
    public function index() 
    {
        ...
        $page_title = 'Super Admin | Administrasi | Pemberhentian | Petikan Keppres yang Hilang/Rusak';
        $page_description = 'Petikan Keppres yang Hilang/Rusak';
        $pangkats = Pangkat::All();
        $periodes = Periode::All();
        return view('pages.super_admin.administrasi.pemberhentian.form.petikan_keppres_hilang', compact('page_title', 'page_description', 'currentUser', 'pangkats', 'periodes'));
    }
