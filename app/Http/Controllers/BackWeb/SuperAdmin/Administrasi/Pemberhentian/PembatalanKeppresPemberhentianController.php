...
class PembatalanKeppresPemberhentianController extends Controller
{
    ...
    public function index() 
    {
        ...
        $page_title = 'Super Admin | Administrasi | Pemberhentian | Pembatalan Keppres Pemberhentian';
        $page_description = 'Pembatalan Keppres Pemberhentian';
        $pangkats = Pangkat::All();
        $periodes = Periode::All();
        return view('pages.super_admin.administrasi.pemberhentian.form.pembatalan_keppres_pemberhentian', compact('page_title', 'page_description', 'currentUser', 'pangkats', 'periodes'));
    }
