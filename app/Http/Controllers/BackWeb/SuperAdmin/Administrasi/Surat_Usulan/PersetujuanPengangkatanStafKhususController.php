...
namespace App\Http\Controllers\BackWeb\SuperAdmin\Administrasi\Surat_Usulan;
...
class PersetujuanPengangkatanStafKhususController extends Controller
{
    ...
    public function index() 
    {
        ...
        $page_title = 'Super Admin | Administrasi | Surat Usulan | Persetujuan pengangkatan Staf Khusus Menteri / Kepala Lembaga';
        $page_description = 'Persetujuan pengangkatan Staf Khusus Menteri / Kepala Lembaga';
        $pangkats = Pangkat::All();
        $periodes = Periode::All();
        return view('pages.super_admin.administrasi.surat_usulan.form.persetujuan_pengangkatan_staf_khusus', compact('page_title', 'page_description', 'currentUser', 'pangkats', 'periodes'));
    }
