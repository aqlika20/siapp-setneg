...
class PengangkatanPejabatNonStrukturalController extends Controller
{
    ...
    public function index() 
    {
        ...
        $page_title = 'Super Admin | Administrasi | Surat Usulan | Pengangkatan Pejabat Non Struktural';
        $page_description = 'Pengangkatan Pejabat Non Struktural';
        $pangkats = Pangkat::All();
        $periodes = Periode::All();
        return view('pages.super_admin.administrasi.surat_usulan.form.pengangkatan_pejabat_ns', compact('page_title', 'page_description', 'currentUser', 'pangkats', 'periodes'));
    }
