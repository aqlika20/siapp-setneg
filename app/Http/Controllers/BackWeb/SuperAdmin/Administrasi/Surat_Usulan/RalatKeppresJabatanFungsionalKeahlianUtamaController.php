...
class RalatKeppresJabatanFungsionalKeahlianUtamaController extends Controller
{
    ...
    public function index() 
    {
        ...
        $page_title = 'Super Admin | Administrasi | Surat Usulan | Ralat Keppres Jabatan Fungsional Keahlian Utama';
        $page_description = 'Ralat Keppres Jabatan Fungsional Keahlian Utama';
        $pangkats = Pangkat::All();
        $periodes = Periode::All();
        return view('pages.super_admin.administrasi.surat_usulan.form.ralat_keppres_jabatan_fku', compact('page_title', 'page_description', 'currentUser', 'pangkats', 'periodes'));
    }
