...
class PembatalanKeppresJabatanNonStrukturalController extends Controller
{
    ...
    public function index() 
    {
        ...
        $page_title = 'Super Admin | Administrasi | Surat Usulan | Pembatalan Keppres Jabatan Non Struktural';
        $page_description = 'Pembatalan Keppres Jabatan Non Struktural';
        $pangkats = Pangkat::All();
        $periodes = Periode::All();
        return view('pages.super_admin.administrasi.surat_usulan.form.pembatalan_keppres_jabatan_ns', compact('page_title', 'page_description', 'currentUser', 'pangkats', 'periodes'));
    }
