...
class PemberhentianPejabatNonStrukturalController extends Controller
{
    ...
    public function index() 
    {
        ...
        $page_title = 'Super Admin | Administrasi | Surat Usulan | Pemberhentian Pejabat Non Struktural';
        $page_description = 'Pemberhentian Pejabat Non Struktural';
        $pangkats = Pangkat::All();
        $periodes = Periode::All();
        return view('pages.super_admin.administrasi.surat_usulan.form.pemberhentian_pejabat_ns', compact('page_title', 'page_description', 'currentUser', 'pangkats', 'periodes'));
    }
