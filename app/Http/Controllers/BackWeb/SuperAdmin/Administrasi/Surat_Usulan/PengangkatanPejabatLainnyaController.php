...
class PengangkatanPejabatLainnyaController extends Controller
{
    ...
    public function index() 
    {
        ...
        $page_title = 'Super Admin | Administrasi | Surat Usulan | Pengangkatan Pejabat Lainnya';
        $page_description = 'Pengangkatan Pejabat Lainnya';
        $pangkats = Pangkat::All();
        $periodes = Periode::All();
        return view('pages.super_admin.administrasi.surat_usulan.form.pengangkatan_pejabat_lainnya', compact('page_title', 'page_description', 'currentUser', 'pangkats', 'periodes'));
    }
