...
class PembatalanKeppresJabatanLainnyaController extends Controller
{
    ...
    public function index() 
    {
        ...
        $page_title = 'Super Admin | Administrasi | Surat Usulan | Pembatalan Keppres Jabatan Lainnya';
        $page_description = 'Pembatalan Keppres Jabatan Lainnya';
        $pangkats = Pangkat::All();
        $periodes = Periode::All();
        return view('pages.super_admin.administrasi.surat_usulan.form.pembatalan_keppres_jabatan_lainnya', compact('page_title', 'page_description', 'currentUser', 'pangkats', 'periodes'));
    }
