...
class PembatalanKeppresKenaikanPangkatController extends Controller
{
    ...
    public function index() 
    {
        ...
        $page_title = 'Super Admin | Administrasi | Kenaikan Pangkat | Pembatalan Keppres Kenaikan Pangkat';
        $page_description = 'Pembatalan Keppres Kenaikan Pangkat';
        $pangkats = Pangkat::All();
        $periodes = Periode::All();
        return view('pages.super_admin.administrasi.kenaikan_pangkat.form.pembatalan_keppres_kenaikan_pangkat', compact('page_title', 'page_description', 'currentUser', 'pangkats', 'periodes'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $pengangkatans = Pengangkatan::create([
            ...
            'jenis_usulan' => Helper::$pembatalan_keppres_kenaikan_pangkat,
