...
class RalatKeppresKepangkatanController extends Controller
{
    ...
    public function index() 
    {
        ...
        return view('pages.super_admin.administrasi.kenaikan_pangkat.form.ralat_keppres_kepangkatan', compact('page_title', 'page_description', 'currentUser', 'pangkats', 'periodes'));
    }
