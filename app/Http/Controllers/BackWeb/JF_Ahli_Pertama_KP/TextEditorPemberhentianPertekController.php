...
class TextEditorPemberhentianPertekController extends Controller
{
    ...
    public function index($id) 
    {
        ...
        return view('pages.jf_ahli_pertama_kp.inbox.text_editor_pemberhentian', compact('page_title', 'page_description', 'currentUser', 'pengangkatans'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('jf-ahli-pertama-kp.inbox.usulan')->with(['success'=>'Surat Success Pending!!!']);
    }
    ...
    public function tolak(Request $request)
    {
        ...
        return redirect()->route('jf-ahli-pertama-kp.inbox.usulan')->with(['success'=>'Surat Success Tolak!!!']);
    }
}
