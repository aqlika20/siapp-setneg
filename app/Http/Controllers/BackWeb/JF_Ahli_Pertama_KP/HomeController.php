...
class HomeController extends Controller
{
    ...
    public function index() 
    {
        ...
        $page_title = 'JF Ahli Pertama KP | Home';
    ...
    //ralat keppres kepangkatan kenaikan pangkat
        ...
        return view('pages.jf_ahli_pertama_kp.home', compact('page_title', 'page_description', 'currentUser', 'pemberian_kenaikan_pangkat', 'pembatalan_keppres_kenaikan_pangkat', 'pengesahan_kenaikan_pangkat', 'ralat_keppres_kepangkatan'));
