...
class TextEditorJFKUPertekController extends Controller
{
    ...
    public function index($id) 
    {
        ...
        return view('pages.koor_pokja.text_editor_jfku_pertek', compact('page_title', 'page_description', 'currentUser', 'pengangkatans'));
    }
