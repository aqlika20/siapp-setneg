...
class TextEditorKenaikanPertekController extends Controller
{
    ...
    public function index($id) 
    {
        ...
        return view('pages.koor_pokja.inbox.text_editor_kenaikan', compact('page_title', 'page_description', 'currentUser', 'pengangkatans'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('koor-pokja.inbox.kenaikan-pangkat.index')->with(['success'=>'Surat Berhasil Dipending!!!!']);
    }
    public function tolak(Request $request)
    {
        ...
        return redirect()->route('koor-pokja.inbox.kenaikan-pangkat.index')->with(['success'=>'Surat Berhasil Ditolak!']);
    }
}
