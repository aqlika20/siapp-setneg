...
class TextEditorKenaikanPertekController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('koor-pokja.inbox.kenaikan-pangkat.index')->with(['success'=>'Surat Success Pending!!!']);
    }
    public function tolak(Request $request)
    {
        ...
        return redirect()->route('koor-pokja.inbox.kenaikan-pangkat.index')->with(['success'=>'Surat Success Tolak!!!']);
    }
}
