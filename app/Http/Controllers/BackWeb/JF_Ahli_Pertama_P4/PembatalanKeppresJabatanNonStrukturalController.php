...
class PembatalanKeppresJabatanNonStrukturalController extends Controller
{
    ...
    public function index() 
    {
        ...
        $page_title = 'JF Ahli Pertama P4 | Inbox | Pembatalan Keppres Jabatan Non Struktural';
        $page_description = 'Pembatalan Keppres Jabatan Non Struktural';
        return view('pages.jf_ahli_pertama.inbox.pembatalan_keppres_jabatan_ns', compact('page_title', 'page_description', 'currentUser'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $validator = Validator::make($input, [
            ...
            'file_ba_pelantikan.*' => 'max:5000|mimes:jpg,png,jpeg,pdf',
            'file_sumpah_jabatan.*' => 'max:5000|mimes:jpg,png,jpeg,pdf'
        ...
        return redirect()->route('jf-ahli-pertama-p4.inbox.lns.index')->with(['success'=>'Berhasil Ditambahkan!']);
    }
