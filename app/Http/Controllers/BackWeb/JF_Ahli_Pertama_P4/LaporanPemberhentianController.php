...
class LaporanPemberhentianController extends Controller
{
    ...
    public function index() 
    {
        ...
        $page_title = 'JF Ahli Pertama P4 | Inbox | Laporan Pemberhentian';
        $page_description = 'Laporan Pemberhentian';
        $jabatans = Jabatan::All();
        return view('pages.jf_ahli_pertama.inbox.laporan_pemberhentian', compact('page_title', 'page_description', 'currentUser', 'jabatans'));
    }
