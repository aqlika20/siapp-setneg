...
class InboxController extends Controller
{
    ...
    //     $page_title = 'JF Ahli Pertama P4 | inbox';
    ...
    //     return view('pages.jf_ahli_pertama.inbox', compact('page_title', 'page_description', 'currentUser', 'pengangkatans'));
    // }
    ...
    public function usulan() 
    {
        ...
        //jfku
            ...
            $jfku_pendings = PengangkatanPemberhentianJFKU::where([
                ['status', '=', Helper::$pending_jf_ahli_terampil]
            ])->get();

            $jfku_tolaks = PengangkatanPemberhentianJFKU::where([
                ['status', '=', Helper::$tolak_jf_ahli_terampil]
            ])->get();
        //
        ...
        return view('pages.jf_ahli_pertama.inbox.usulan', compact('page_title', 'page_description', 'currentUser', 'pengangkatans', 'jfku_pendings', 'jfku_tolaks', 'pengangkatans_ns', 'ns_pendings', 'ns_tolaks', 'lainnyas', 'lainnya_pendings', 'lainnya_tolaks'));
    }
    ...
    public function verification_ns($id){
        ...
        return view('pages.jf_ahli_pertama.inbox.verif_ns', compact('page_title', 'page_description', 'file_sumpah_jabatans', 'file_ba_pelantikans', 'file_bukti_pendukungs', 'file_keppress', 'file_dukumen_lain_pengangkatan_nss', 'file_dhrs', 'file_surat_pengantars', 'currentUser', 'verifikasi_ns', 'jabatans', 'unsurs'));
    }
    ...
    public function verification_lainnya($id){
        ...
        return view('pages.jf_ahli_pertama.inbox.verif_lainnya', compact('page_title', 'page_description', 'file_sumpah_jabatans', 'file_ba_pelantikans', 'file_bukti_pendukungs', 'file_keppress', 'file_dukumen_lain_pengangkatan_lainnyas', 'file_dhrs', 'file_surat_pengantars', 'currentUser', 'verifikasi_lainnya', 'jabatans', 'unsurs'));
    }
    ...
    public function store_proses(Request $request) 
    {
        ...
        if($jenis_layanan == Helper::$pengangkatan_pejabat_FKU || $jenis_layanan == Helper::$pemberhentian_pejabat_FKU || $jenis_layanan == Helper::$perpindahan_pejabat_FKU || $jenis_layanan == Helper::$ralat_keppres_jabatan_FKU || $jenis_layanan == Helper::$pembatalan_keppres_jabatan_FKU)
        {
            ...
            return redirect()->route('jf-ahli-pertama-p4.inbox.usulan')->with(['success'=>'Verifikasi Berhasil!']);
        }
    }
    ...
    public function store_pending(Request $request) 
    {
        ...
        $id = $input['v_id'];
        $jenis_layanan = $input['v_jenis'];
        $page_title = 'JF Ahli | PENDING | Text Editor';
		...
		{				
			...
			//return view('pages.jf_ahli_pertama.inbox.text_editor_inbox_pending', compact('page_title', 'page_description', 'currentUser', 'pengangkatans','stringrnd','newfilename','urlhead'));
		}
		
		return view('pages.jf_ahli_pertama.inbox.text_editor_inbox_pending', compact('page_title', 'page_description', 'currentUser', 'pengangkatans','stringrnd','newfilename','urlhead','sifat','hal','yth','konten'));        
    }
    ...
    public function store_tolak(Request $request) 
    {
		...
		{	
			...
			//$phpWord = new \PhpOffice\Ph  pWord\PhpWord();
			$filename = "Surat_Pengembalian_Berkas_Template";
			$templateProcessor = new \PhpOffice\PhpWord\TemplateProcessor(storage_path("app/public/Template/".$filename.".docx"));
		...
		return view('pages.jf_ahli_pertama.inbox.text_editor_inbox_tolak', compact('page_title', 'page_description', 'currentUser', 'pengangkatans','stringrnd','newfilename','urlhead','sifat','hal','yth','konten','id_verif','nama_verif')); 
    }
    ...
    public function revisi() {
        ...
        return view('pages.jf_ahli_pertama.inbox.revisi', compact('page_title', 'page_description', 'currentUser'));
    ...
    public function tolak_text_editor(Request $request)
    {
        ...
        if($jenis_layanan == Helper::$pengangkatan_pejabat_FKU || $jenis_layanan == Helper::$pemberhentian_pejabat_FKU || $jenis_layanan == Helper::$perpindahan_pejabat_FKU || $jenis_layanan == Helper::$ralat_keppres_jabatan_FKU || $jenis_layanan == Helper::$pembatalan_keppres_jabatan_FKU)
        {
            ...
            return redirect()->route('jf-ahli-pertama-p4.inbox.usulan')->with(['success'=>'Tolak Berhasil!']);
        } 
        elseif($jenis_layanan == Helper::$pengangkatan_pejabat_NS || $jenis_layanan == Helper::$pemberhentian_pejabat_NS || $jenis_layanan == Helper::$ralat_keppres_jabatan_NS || $jenis_layanan == Helper::$pembatalan_keppres_jabatan_NS )
        {
            $pengangkatans = PengangkatanPemberhentianNS::where('id', '=', $id)->update(
