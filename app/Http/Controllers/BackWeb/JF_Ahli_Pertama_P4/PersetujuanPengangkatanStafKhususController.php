...
class PersetujuanPengangkatanStafKhususController extends Controller
{
    ...
    public function index() 
    {
        ...
        $page_title = 'JF Ahli Pertama P4 | Inbox | Persetujuan pengangkatan Staf Khusus Menteri / Kepala Lembaga';
        $page_description = 'Persetujuan pengangkatan Staf Khusus Menteri / Kepala Lembaga';
        $jabatans = Jabatan::All();
        return view('pages.jf_ahli_pertama.inbox.persetujuan_pengangkatan_staf_khusus', compact('page_title', 'page_description', 'currentUser', 'jabatans'));
    }
