...
class VerifikasiController extends Controller
{
    ...
    public function index($id){
        ...
        if (!$verifikasi) {
            return redirect()->route('jf-ahli-terampil-kp.inbox.index')->with(['error'=>'Invalid parameter id.']);
        }
    
        return view('pages.jf_ahli_terampil_kp.verif', compact('page_title', 'page_description', 'currentUser', 'verifikasi', 'notes'));
    }
    ...
    public function store_proses($id, Request $request) 
    {
        ...
        return redirect()->route('jf-ahli-terampil-kp.inbox.index')->with(['success'=>'verifikasi Success !!!']);
    }
