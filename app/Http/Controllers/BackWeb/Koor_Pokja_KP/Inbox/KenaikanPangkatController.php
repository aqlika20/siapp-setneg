...
class KenaikanPangkatController extends Controller
{
    ...
    public function index() 
    {
        ...
        return view('pages.koor_pokja_kp.inbox.kenaikan_pangkat', compact('jfku_verifikasis', 'page_title', 'page_description', 'currentUser', 'pengangkatans', 'kenaikan_pendings', 'jfku_tolaks', 'group_lists', 'group_users', 'group_roles'));
    }
