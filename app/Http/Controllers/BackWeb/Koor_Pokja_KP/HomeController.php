...
class HomeController extends Controller
{
    ...
    //ralat keppres kepangkatan kenaikan pangkat
        ...
        // var_dump($json_chart);
        return view('pages.koor_pokja_kp.home', compact('page_title', 'page_description', 'currentUser', 'pemberian_kenaikan_pangkat', 'pembatalan_keppres_kenaikan_pangkat', 'pengesahan_kenaikan_pangkat', 'ralat_keppres_kepangkatan'));
