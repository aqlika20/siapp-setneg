...
class RKPController extends Controller
{
    ...
    public function home() 
    {
        ...
        return view('pages.koor_pokja_pensiun.rkp', compact('page_title', 'page_description', 'currentUser'));
    }
    ...
    public function index($id) 
    {
        ...
        // {
        //     return view('pages.koor_pokja_pensiun.rkp', compact('page_title', 'page_description', 'currentUser', 'pengangkatan', 'ns', 'lainnya', 'pemberhentian', 'kenaikan'));
        // } 
