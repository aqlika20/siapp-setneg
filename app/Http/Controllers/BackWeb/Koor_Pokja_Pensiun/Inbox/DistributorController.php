...
class DistributorController extends Controller
{
    ...
    public function index($id, $jenis_layanan) 
    {
        ...
        {
            return view('pages.koor_pokja_pensiun.inbox.distributor', compact('page_title', 'page_description', 'currentUser', 'group_lists', 'group_users', 'group_roles', 'pengangkatans'));
        } 
        ...
        {
            return view('pages.koor_pokja_pensiun.inbox.distributor_ns', compact('page_title', 'page_description', 'currentUser', 'group_lists', 'group_users', 'group_roles', 'ns'));    
        }
        ...
        {
            return view('pages.koor_pokja_pensiun.inbox.distributor_lainnya', compact('page_title', 'page_description', 'currentUser', 'group_lists', 'group_users', 'group_roles', 'lainnya'));
        }
        ...
        {
            return view('pages.koor_pokja_pensiun.inbox.distributor_kenaikan', compact('page_title', 'page_description', 'currentUser', 'group_lists', 'group_users', 'group_roles', 'kenaikan'));
        }
    ...
    public function store_group($id, $jenis_layanan, Request $request) 
    {
        ...
        if($jenis_layanan == Helper::$pengangkatan_pejabat_FKU || $jenis_layanan == Helper::$pemberhentian_pejabat_FKU || $jenis_layanan == Helper::$perpindahan_pejabat_FKU || $jenis_layanan == Helper::$ralat_keppres_jabatan_FKU || $jenis_layanan == Helper::$pembatalan_keppres_jabatan_FKU)
        {
            ...
            return redirect()->route('koor-pokja-pensiun.inbox.jfku.index')->with(['success'=>'Distribusi Group Success !!!']);
        }
        elseif($jenis_layanan == Helper::$pengangkatan_pejabat_NS || $jenis_layanan == Helper::$pemberhentian_pejabat_NS || $jenis_layanan == Helper::$ralat_keppres_jabatan_NS || $jenis_layanan == Helper::$pembatalan_keppres_jabatan_NS )
        {
    ...
    public function store_distributor($id, $jenis_layanan, Request $request) 
    {
        ...
        if($jenis_layanan == Helper::$pengangkatan_pejabat_FKU || $jenis_layanan == Helper::$pemberhentian_pejabat_FKU || $jenis_layanan == Helper::$perpindahan_pejabat_FKU || $jenis_layanan == Helper::$ralat_keppres_jabatan_FKU || $jenis_layanan == Helper::$pembatalan_keppres_jabatan_FKU)
        {
            ...
            return redirect()->route('koor-pokja-pensiun.inbox.jfku.index')->with(['success'=>'Distribusi Perorangan Success !!!']);
        }
        elseif($jenis_layanan == Helper::$pengangkatan_pejabat_NS || $jenis_layanan == Helper::$pemberhentian_pejabat_NS || $jenis_layanan == Helper::$ralat_keppres_jabatan_NS || $jenis_layanan == Helper::$pembatalan_keppres_jabatan_NS )
        {
            $pengangkatans = PengangkatanPemberhentianNS::where('id', '=', $id)->update(
