...
namespace App\Http\Controllers\backweb\JF_Ahli_Pertama_Pensiun;
...
class InboxController extends Controller
{
    ...
    public function usulan() 
    {
        ...
        return view('pages.jf_ahli_pertama_pensiun.inbox.usulan', compact('page_title', 'page_description', 'currentUser', 'pemberhentians', 'pemberhentian_pendings', 'pemberhentian_tolaks' ));
    }
    ...
    public function verification_pemberhentian($id){
        ...
        if (!$verifikasi) {
            return redirect()->route('pages.jf_ahli_pertama_pensiun.inbox.usulan')->with(['error'=>'Invalid parameter id.']);
        }
    
        return view('pages.jf_ahli_pertama_pensiun.inbox.verif_pemberhentian', compact('page_title', 'page_description', 'file_sumpah_jabatans', 'file_ba_pelantikans', 'file_bukti_pendukungs', 'file_keppress', 'file_surat_pengantars', 'file_klarifikasi_paks', 'file_data_paks', 'file_data_usulans', 'currentUser', 'verifikasi', 'jabatans', 'unsurs', 'periodes', 'notes', 'pangkats'));
    }
       ...
       if($jenis_layanan == Helper::$bup_non_kpp || $jenis_layanan == Helper::$bup_kpp || $jenis_layanan == Helper::$berhenti_atas_permintaan_sendiri || $jenis_layanan == Helper::$non_bup_JDA_non_kpp || $jenis_layanan == Helper::$non_bup_JDA_kpp || $jenis_layanan == Helper::$berhenti_tidak_hormat || $jenis_layanan == Helper::$anumerta || $jenis_layanan == Helper::$pemberhentian_sementara || $jenis_layanan == Helper::$ralat_keppres_pemberhentian || $jenis_layanan == Helper::$pembatalan_keppress_pemberhentian || $jenis_layanan == Helper::$petikan_keppres_hilang)
        {
            ...
            return redirect()->route('jf-ahli-pertama-pensiun.inbox.usulan')->with(['success'=>'Verifikasi Berhasil!']);
        }
    ...
    public function store_pending(Request $request) 
    {
        ...
        if($jenis_layanan == Helper::$bup_non_kpp || $jenis_layanan == Helper::$bup_kpp || $jenis_layanan == Helper::$berhenti_atas_permintaan_sendiri || $jenis_layanan == Helper::$non_bup_JDA_non_kpp || $jenis_layanan == Helper::$non_bup_JDA_kpp || $jenis_layanan == Helper::$berhenti_tidak_hormat || $jenis_layanan == Helper::$anumerta || $jenis_layanan == Helper::$pemberhentian_sementara || $jenis_layanan == Helper::$ralat_keppres_pemberhentian || $jenis_layanan == Helper::$pembatalan_keppress_pemberhentian || $jenis_layanan == Helper::$petikan_keppres_hilang)
        {
            ...
            return redirect()->route("jf-ahli-pertama-pensiun.inbox.text-editor.pemberhentian.index", [$id])->with(['success'=>'Verifikasi Berhasil!']);          
        }
    ...
    public function revisi() {
        ...
        return view('pages.jf_ahli_pertama_pensiun.inbox.revisi', compact('page_title', 'page_description', 'currentUser'));
