...
class PemberhentianPejabatNonStrukturalController extends Controller
{
   ...
   /**
    ...
    public function index() 
    {
        ...
        $page_title = 'JF Ahli Terampil P4 | Inbox | Pemberhentian Pejabat Non Struktural';
        $page_description = 'Pemberhentian Pejabat Non Struktural';
        $jabatans = Jabatan::All();
        $unsurs = Unsur::All();
        return view('pages.jf_ahli_terampil.inbox.pemberhentian_pejabat_ns', compact('page_title', 'page_description', 'currentUser', 'jabatans', 'unsurs'));
    }
