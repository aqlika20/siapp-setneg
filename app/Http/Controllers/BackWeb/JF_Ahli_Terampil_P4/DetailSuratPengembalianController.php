...
class DetailSuratPengembalianController extends Controller
{
    ...
    public function index($id) 
    {
        ...
        return view('pages.jf_ahli_terampil.inbox.detail_surat_pengembalian', compact('page_title', 'page_description', 'currentUser', 'surats','stringrnd','newfilename','urlhead'));
    }
