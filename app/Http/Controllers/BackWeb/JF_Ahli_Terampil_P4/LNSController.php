...
class LNSController extends Controller
{
    ...
    public function index() 
    {
        ...
        $page_title = 'JF Ahli Terampil P4 | Inbox | Modul Kontrol LNS';
        ...
        return view('pages.jf_ahli_terampil.inbox.lns', compact('page_title', 'page_description', 'currentUser', 'strukturals', 'lainnyas'));
    }
}
