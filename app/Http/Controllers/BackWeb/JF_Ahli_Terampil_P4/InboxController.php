...
class InboxController extends Controller
{
    ...
    //     $page_title = 'JF Ahli Terampil P4 | inbox';
    ...
    //     return view('pages.jf_ahli_terampil.inbox', compact('page_title', 'page_description', 'currentUser', 'pengangkatans'));
    // }
    ...
    public function usulan() 
    {
        ...
        return view('pages.jf_ahli_terampil.inbox.usulan', compact('page_title', 'page_description', 'currentUser', 'pengangkatans', 'jfku_pendings', 'jfku_tolaks', 'pengangkatans_ns', 'ns_pendings', 'ns_tolaks', 'lainnyas', 'lainnya_pendings', 'lainnya_tolaks'));
    }
    ...
    public function verification_ns($id){
        ...
        return view('pages.jf_ahli_terampil.inbox.verif_ns', compact('page_title', 'page_description', 'file_sumpah_jabatans', 'file_ba_pelantikans', 'file_bukti_pendukungs', 'file_keppress', 'file_dukumen_lain_pengangkatan_nss', 'file_dhrs', 'file_surat_pengantars', 'currentUser', 'verifikasi_ns', 'jabatans', 'unsurs'));
    }
    ...
    public function verification_lainnya($id){
        ...
        return view('pages.jf_ahli_terampil.inbox.verif_lainnya', compact('page_title', 'page_description', 'file_sumpah_jabatans', 'file_ba_pelantikans', 'file_bukti_pendukungs', 'file_keppress', 'file_dukumen_lain_pengangkatan_lainnyas', 'file_dhrs', 'file_surat_pengantars', 'currentUser', 'verifikasi_lainnya', 'jabatans', 'unsurs'));
    }
    ...
    public function store_proses(Request $request) 
    {
        ...
        if($jenis_layanan == Helper::$pengangkatan_pejabat_FKU || $jenis_layanan == Helper::$pemberhentian_pejabat_FKU || $jenis_layanan == Helper::$perpindahan_pejabat_FKU || $jenis_layanan == Helper::$ralat_keppres_jabatan_FKU || $jenis_layanan == Helper::$pembatalan_keppres_jabatan_FKU)
        {
            ...
            return redirect()->route('jf-ahli-terampil-p4.inbox.usulan')->with(['success'=>'Verifikasi Berhasil!']);
        }
    }
    ...
    public function store_pending(Request $request) 
    {
		...
		{				
			...
			//return view('pages.jf_ahli_terampil.inbox.text_editor_inbox_pending', compact('page_title', 'page_description', 'currentUser', 'pengangkatans','stringrnd','newfilename','urlhead'));
		}
		
		return view('pages.jf_ahli_terampil.inbox.text_editor_inbox_pending', compact('page_title', 'page_description', 'currentUser', 'pengangkatans','stringrnd','newfilename','urlhead','sifat','hal','yth','konten'));        
    }
    ...
    public function store_tolak(Request $request) 
    {
		...
		return view('pages.jf_ahli_terampil.inbox.text_editor_inbox_tolak', compact('page_title', 'page_description', 'currentUser', 'pengangkatans','stringrnd','newfilename','urlhead','sifat','hal','yth','konten','id_verif','nama_verif')); 
    }
    ...
    public function revisi() {
        ...
        return view('pages.jf_ahli_terampil.inbox.revisi', compact('page_title', 'page_description', 'currentUser'));
    ...
    public function tolak_text_editor(Request $request)
    {
        ...
        if($jenis_layanan == Helper::$pengangkatan_pejabat_FKU || $jenis_layanan == Helper::$pemberhentian_pejabat_FKU || $jenis_layanan == Helper::$perpindahan_pejabat_FKU || $jenis_layanan == Helper::$ralat_keppres_jabatan_FKU || $jenis_layanan == Helper::$pembatalan_keppres_jabatan_FKU)
        {
            ...
            return redirect()->route('jf-ahli-terampil-p4.inbox.usulan')->with(['success'=>'Tolak Berhasil!']);
        } 
        elseif($jenis_layanan == Helper::$pengangkatan_pejabat_NS || $jenis_layanan == Helper::$pemberhentian_pejabat_NS || $jenis_layanan == Helper::$ralat_keppres_jabatan_NS || $jenis_layanan == Helper::$pembatalan_keppres_jabatan_NS )
        {
            $pengangkatans = PengangkatanPemberhentianNS::where('id', '=', $id)->update(
