...
class RalatKeppresJabatanNonStrukturalController extends Controller
{
    ...
    public function index() 
    {
        ...
        $page_title = 'JF Ahli Terampil P4 | Inbox | Ralat Keppres Jabatan Non Struktural';
        $page_description = 'Ralat Keppres Jabatan Non Struktural';
        return view('pages.jf_ahli_terampil.inbox.ralat_keppres_jabatan_ns', compact('page_title', 'page_description', 'currentUser'));
    }
