...
class TextEditorInboxPendingController extends Controller
{
    ...
    public function index($id) 
    {
        ...
        return view('pages.jf_ahli_terampil.inbox.text_editor_inbox_pending', compact('page_title', 'page_description', 'currentUser', 'pengangkatans'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('jf-ahli-pertama-p4.inbox.usulan')->with(['success'=>'Surat Berhasil Dipending!!!!']);
    }
    ...
    public function tolak(Request $request)
    {
        ...
        return redirect()->route('jf-ahli-pertama-p4.inbox.usulan')->with(['success'=>'Surat Berhasil Ditolak!']);
    }
}
