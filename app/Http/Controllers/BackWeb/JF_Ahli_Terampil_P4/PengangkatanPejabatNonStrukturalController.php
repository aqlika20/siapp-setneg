...
class PengangkatanPejabatNonStrukturalController extends Controller
{
    ...
    public function index() 
    {
        ...
        $page_title = 'JF Ahli Terampil P4 | Inbox | Pengangkatan Pejabat Non Struktural';
        $page_description = 'Pengangkatan Pejabat Non Struktural';
        $jabatans = Jabatan::All();
        $unsurs = Unsur::All();
        $unsur_nons = UnsurNon::All();
        return view('pages.jf_ahli_terampil.inbox.pengangkatan_pejabat_ns', compact('page_title', 'page_description', 'currentUser', 'jabatans', 'unsurs', 'unsur_nons'));
    }
