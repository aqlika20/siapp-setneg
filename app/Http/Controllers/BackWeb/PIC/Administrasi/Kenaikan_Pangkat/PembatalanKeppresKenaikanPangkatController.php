...
class PembatalanKeppresKenaikanPangkatController extends Controller
{
    ...
    public function index() 
    {
        ...
        return view('pages.pic.administrasi.kenaikan_pangkat.form.pembatalan_keppres_kenaikan_pangkat', compact('page_title', 'page_description', 'currentUser', 'pangkats', 'periodes'));
    }
