...
class RalatKeppresJabatanNonStrukturalController extends Controller
{
    ...
    public function index() 
    {
        ...
        $page_title = 'PIC | Administrasi | Surat Usulan | Ralat Keppres Jabatan Non Struktural';
        $page_description = 'Ralat Keppres Jabatan Non Struktural';
        $pangkats = Pangkat::All();
        $periodes = Periode::All();
        return view('pages.pic.administrasi.surat_usulan.form.ralat_keppres_jabatan_ns', compact('page_title', 'page_description', 'currentUser', 'pangkats', 'periodes'));
    }
