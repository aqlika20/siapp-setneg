...
class PengangkatanPejabatLainnyaController extends Controller
{
    ...
    public function index() 
    {
        ...
        return view('pages.pic.administrasi.surat_usulan.form.pengangkatan_pejabat_lainnya', compact('unsur_nons', 'page_title', 'page_description', 'currentUser', 'jabatans', 'unsurs'));
    }
