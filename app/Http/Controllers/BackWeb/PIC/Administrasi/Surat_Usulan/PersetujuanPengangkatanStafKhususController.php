...
class PersetujuanPengangkatanStafKhususController extends Controller
{
    ...
    public function index() 
    {
        ...
        return view('pages.pic.administrasi.surat_usulan.form.persetujuan_pengangkatan_staf_khusus', compact('page_title', 'page_description', 'currentUser', 'pangkats', 'periodes'));
    }
