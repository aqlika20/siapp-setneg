...
class PembatalanKeppresJabatanLainnyaController extends Controller
{
    ...
    public function index() 
    {
        ...
        return view('pages.pic.administrasi.surat_usulan.form.pembatalan_keppres_jabatan_lainnya', compact('page_title', 'page_description', 'currentUser', 'pangkats', 'periodes'));
    }
