...
class NonBUPJDAKPPController extends Controller
{
    ...
    public function index() 
    {
        ...
        $page_title = 'PIC | Administrasi | Pemberhentian | Non BUP Janda/Duda/Anak KPP';
        $page_description = 'Non BUP Janda/Duda/Anak KPP';
        $pangkats = Pangkat::All();
        $periodes = Periode::All();
        $pendidikans = Pendidikan::All();
        return view('pages.pic.administrasi.pemberhentian.form.non_bup_jda_kpp', compact('pendidikans', 'page_title', 'page_description', 'currentUser', 'pangkats', 'periodes'));
    }
