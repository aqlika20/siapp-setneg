...
class BerhentiAtasPermintaanSendiriController extends Controller
{
    ...
    public function index() 
    {
        ...
        return view('pages.pic.administrasi.pemberhentian.form.berhenti_atas_permintaan_sendiri', compact('page_title', 'page_description', 'currentUser', 'pangkats', 'periodes'));
    }
