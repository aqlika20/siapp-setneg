...
class PemberhentianPejabatLainnyaController extends Controller
{
    ...
    public function index() 
    {
        ...
        $page_title = 'PIC | Pertek BKN | Surat Usulan | Pemberhentian Pejabat Lainnya';
        $page_description = 'Pemberhentian Pejabat Lainnya';
        $jabatans = Jabatan::All();
        $unsurs = Unsur::All();
        return view('pages.pic.pertek_bkn.surat_usulan.form.pemberhentian_pejabat_lainnya', compact('page_title', 'page_description', 'currentUser', 'jabatans', 'unsurs'));
    }
