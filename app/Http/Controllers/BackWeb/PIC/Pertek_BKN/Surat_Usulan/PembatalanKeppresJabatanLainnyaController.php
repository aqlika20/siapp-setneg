...
class PembatalanKeppresJabatanLainnyaController extends Controller
{
    ...
    public function index() 
    {
        ...
        $page_title = 'PIC | Pertek BKN | Surat Usulan | Pembatalan Keppres Jabatan Lainnya';
        $page_description = 'Pembatalan Keppres Jabatan Lainnya';
        $jabatans = Jabatan::All();
        $unsurs = Unsur::All();
        return view('pages.pic.pertek_bkn.surat_usulan.form.pembatalan_keppres_jabatan_lainnya', compact('page_title', 'page_description', 'currentUser', 'jabatans', 'unsurs'));
    }
