...
class RalatKeppresJabatanNonStrukturalController extends Controller
{
    ...
    public function index() 
    {
        ...
        $page_title = 'PIC | Pertek BKN | Surat Usulan | Ralat Keppres Jabatan Non Struktural';
        $page_description = 'Ralat Keppres Jabatan Non Struktural';
        return view('pages.pic.pertek_bkn.surat_usulan.form.ralat_keppres_jabatan_ns', compact('page_title', 'page_description', 'currentUser'));
    }
