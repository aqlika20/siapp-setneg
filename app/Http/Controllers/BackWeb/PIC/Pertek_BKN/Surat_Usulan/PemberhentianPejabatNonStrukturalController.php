...
class PemberhentianPejabatNonStrukturalController extends Controller
{
   ...
   /**
    ...
    public function index() 
    {
        ...
        $page_title = 'PIC | Pertek BKN | Surat Usulan | Pemberhentian Pejabat Non Struktural';
        $page_description = 'Pemberhentian Pejabat Non Struktural';
        $jabatans = Jabatan::All();
        $unsurs = Unsur::All();
        return view('pages.pic.pertek_bkn.surat_usulan.form.pemberhentian_pejabat_ns', compact('page_title', 'page_description', 'currentUser', 'jabatans', 'unsurs'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $validator = Validator::make($input, [
            ...
            'req_file_dukumen_lain_pengangkatan_ns.*' => 'max:25000|mimes:jpg,png,jpeg,pdf'
