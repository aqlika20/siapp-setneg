...
class PengangkatanPejabatLainnyaController extends Controller
{
    ...
    public function index() 
    {
        ...
        $page_title = 'PIC | Pertek BKN | Surat Usulan | Pengangkatan Pejabat Lainnya';
        $page_description = 'Pengangkatan Pejabat Lainnya';
        $jabatans = Jabatan::All();
        $unsurs = Unsur::All();
        return view('pages.pic.pertek_bkn.surat_usulan.form.pengangkatan_pejabat_lainnya', compact('page_title', 'page_description', 'currentUser', 'jabatans', 'unsurs'));
    }
