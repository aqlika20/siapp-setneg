...
class PemberhentianController extends Controller
{
    ...
    public function index() 
    {
        ...
        $page_title = 'PIC | Pertek BKN | Pemberhentian';
        $page_description = 'Pemberhentian';
        $pengangkatans = Pemberhentian::where([
            ['status', '=', Helper::$pengajuan_usulan],
            ['id_pengirim', '=', $currentUser->nip]
        ])->get();
        return view('pages.pic.pertek_bkn.pemberhentian.pemberhentian', compact('page_title', 'page_description', 'currentUser', 'pengangkatans'));
    }
}
