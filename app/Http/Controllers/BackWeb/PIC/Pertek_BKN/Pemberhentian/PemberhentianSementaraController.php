...
class PemberhentianSementaraController extends Controller
{
    ...
    public function index() 
    {
        ...
        $page_title = 'PIC | Pertek BKN | Pemberhentian | Pemberhentian Sementara';
        $page_description = 'Pemberhentian Sementara';
        $pangkats = Pangkat::All();
        $periodes = Periode::All();
        return view('pages.pic.pertek_bkn.pemberhentian.form.pemberhentian_sementara', compact('page_title', 'page_description', 'currentUser', 'pangkats', 'periodes'));
    }
