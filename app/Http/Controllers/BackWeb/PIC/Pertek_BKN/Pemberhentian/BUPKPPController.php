...
class BUPKPPController extends Controller
{
   /**
    ...
    public function index() 
    {
        ...
        $page_title = 'PIC | Pertek BKN | Pemberhentian | BUP KPP';
        $page_description = 'BUP KPP';
        $pangkats = Pangkat::All();
        $periodes = Periode::All();
        return view('pages.pic.pertek_bkn.pemberhentian.form.bup_kpp', compact('page_title', 'page_description', 'currentUser', 'pangkats', 'periodes'));
    }
