...
class NonBUPJDAKPPController extends Controller
{
    ...
    public function index() 
    {
        ...
        $page_title = 'PIC | Pertek BKN | Pemberhentian | Non BUP Janda/Duda/Anak KPP';
        $page_description = 'Non BUP Janda/Duda/Anak KPP';
        $pangkats = Pangkat::All();
        $periodes = Periode::All();
        return view('pages.pic.pertek_bkn.pemberhentian.form.non_bup_jda_kpp', compact('page_title', 'page_description', 'currentUser', 'pangkats', 'periodes'));
    }
