...
class AnumertaController extends Controller
{
    ...
    public function index() 
    {
        ...
        $page_title = 'PIC | Pertek BKN | Pemberhentian | Anumerta';
        $page_description = 'Anumerta';
        $pangkats = Pangkat::All();
        $periodes = Periode::All();
        return view('pages.pic.pertek_bkn.pemberhentian.form.anumerta', compact('page_title', 'page_description', 'currentUser', 'pangkats', 'periodes'));
    }
