...
class BerhentiAtasPermintaanSendiriController extends Controller
{
    ...
    public function index() 
    {
        ...
        $page_title = 'PIC | Pertek BKN | Pemberhentian | Berhenti Atas Permintaan Sendiri';
        $page_description = 'Berhenti Atas Permintaan Sendiri';
        $pangkats = Pangkat::All();
        $periodes = Periode::All();
        return view('pages.pic.pertek_bkn.pemberhentian.form.berhenti_atas_permintaan_sendiri', compact('page_title', 'page_description', 'currentUser', 'pangkats', 'periodes'));
    }
