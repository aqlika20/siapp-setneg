...
class PembatalanKeppresKenaikanPangkatController extends Controller
{
    ...
    public function index() 
    {
        ...
        $page_title = 'PIC | Pertek BKN | Kenaikan Pangkat | Pembatalan Keppres Kenaikan Pangkat';
        $page_description = 'Pembatalan Keppres Kenaikan Pangkat';
        return view('pages.pic.pertek_bkn.kenaikan_pangkat.form.pembatalan_keppres_kenaikan_pangkat', compact('page_title', 'page_description', 'currentUser'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('pic.pertek-bkn.kenaikan-pangkat.index')->with(['success'=>'Berhasil Ditambahkan!']);
    }
