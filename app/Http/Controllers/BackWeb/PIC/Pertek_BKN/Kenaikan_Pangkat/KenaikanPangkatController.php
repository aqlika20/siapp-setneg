...
class KenaikanPangkatController extends Controller
{
    ...
    public function index() 
    {
        ...
        $page_title = 'PIC | Pertek BKN | Kenaikan Pangkat';
        $page_description = 'Kenaikan Pangkat';
        $pengangkatans = KenaikanPangkat::where([
            ['status', '=', Helper::$pengajuan_usulan],
            ['id_pengirim', '=', $currentUser->nip]
        ])->get();
        return view('pages.pic.pertek_bkn.kenaikan_pangkat.kenaikan_pangkat', compact('page_title', 'page_description', 'currentUser', 'pengangkatans'));
    }
