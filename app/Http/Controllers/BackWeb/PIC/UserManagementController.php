...
class UserManagementController extends Controller
{
    ...
    public function index() 
    {
        ...
        $page_title = 'PIC | User Management';
        $page_description = 'All User List';
        $users = UserManagement::All();
        return view('pages.pic.user_management', compact('page_title', 'page_description', 'currentUser', 'users'));
    }
    ...
    public function create(Request $request) 
    {
        ...
        if ($validator->fails())
        {
            return redirect()->route('pic.user-management.index')->with(['error'=>'Data not valid.']);
        }
        ...
        return redirect()->route('pic.user-management.index')->with(['success'=>'Data created.']);
    }
    ...
    public function view($id) 
    {
        ...
        return view('pages.pic.user_management_edit', compact('page_title', 'page_description', 'currentUser', 'user'));
    }
    ...
    public function edit($id, Request $request)
    {
        ...
        return redirect()->route('pic.user-management.index')->with(['success'=>'Data edited.']);
    }
