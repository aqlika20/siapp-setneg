...
namespace App\Http\Controllers\backweb\Tu_Kementerian;
...
class HomeController extends Controller
{
    ...
    public function index() 
    {
        ...
        $page_title = 'TU Kementerian | Home';
